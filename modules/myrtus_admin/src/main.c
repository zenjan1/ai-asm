/* myrtus_admin: Myrtus management technology administration (v1.0)
 * Myrtus planning, myrtus execution, myrtus evaluation, accessories, marketing
 */
#include <stddef.h>
...
int main(void){
ps("=== Myrtus Admin Demo ===\n\n");myrt_init();
ps("Myrtus planning...\n");for(int i=0;i<N;i++){int t=(i%5)+1,c=(i%4)+1;myrt_planning(t,c,1957+(i*17),1946+(i*14),1926+(i*10),1908+(i*6),2020+(i%5));}
ps("\nMyrtus execution...\n");for(int i=0;i<N-2;i++){int t=(i%4)+1,c=(i%5)+1;myrt_execution(t,c,1946+(i*15),1935+(i*12),1917+(i*8),1904+(i*5),2021+(i%4));}
ps("\nMyrtus evaluation...\n");for(int i=0;i<N-4;i++){int t=(i%4)+1,c=(i%5)+1;myrt_evaluation(t,c,1938+(i*13),1927+(i*10),1911+(i*7),1900+(i*4),2022+(i%3));}
ps("\nMyrtus accessories...\n");for(int i=0;i<N-6;i++){int t=(i%4)+1,c=(i%5)+1;myrt_accessory(t,c,1930+(i*11),1921+(i*9),1907+(i*6),1897+(i*3),2023+(i%2));}
ps("\nMyrtus marketing...\n");for(int i=0;i<N-6;i++){int t=(i%4)+1,c=(i%5)+1;myrt_market(t,c,1924+(i*9),1915+(i*7),1902+(i*5),1894+(i*3),2024);}
