...
**181 WASM modules** · 7244152 bytes kernel · v188.0
...
### Network: ifconfig, ping, netstat, route, traceroute, nslookup, wget, curl, ssh, scp, nmap, dig, arp, iwconfig, ifup, nc, iptables, socat, tcpdump, ping6, ethtool, arping, brctl, ifstat, mii-tool, nameif
...
| Kernel binary | ~6.9MB (7244152 bytes) |
| Assembly files | 26 |
| WASM modules | 181 |
