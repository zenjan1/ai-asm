...
**180 WASM modules** · 7244024 bytes kernel · v187.0
...
### Network: ifconfig, ping, netstat, route, traceroute, nslookup, wget, curl, ssh, scp, nmap, dig, arp, iwconfig, ifup, nc, iptables, socat, tcpdump, ping6, ethtool, arping, brctl, ifstat, mii-tool
...
| Kernel binary | ~6.9MB (7244024 bytes) |
| Assembly files | 26 |
| WASM modules | 180 |
