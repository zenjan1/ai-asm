...
**182 WASM modules** · 7244296 bytes kernel · v189.0
...
### Network: ifconfig, ping, netstat, route, traceroute, nslookup, wget, curl, ssh, scp, nmap, dig, arp, iwconfig, ifup, nc, iptables, socat, tcpdump, ping6, ethtool, arping, brctl, ifstat, mii-tool, nameif, plipconfig
...
| Kernel binary | ~6.9MB (7244296 bytes) |
| Assembly files | 26 |
| WASM modules | 182 |
