...
NAMEIF_WASM      = $(MODULES_DIR)/nameif/nameif.wasm $(MODULES_DIR)/plipconfig/plipconfig.wasm
PLIPCONFIG_WASM  = $(MODULES_DIR)/plipconfig/plipconfig.wasm
...
# ---------------------------------------------------------------------------
$(PING6_WASM) $(ETHTOOL_WASM) $(ARPING_WASM) $(BRCTL_WASM) $(IFSTAT_WASM) $(MII_TOOL_WASM) $(NAMEIF_WASM) $(PLIPCONFIG_WASM) $(RAMDISK_TAR): ramdisk/motd.txt ramdisk/hello.txt ramdisk/readme.txt
	@echo "  TAR   $@"
...
# Full kernel link
# ---------------------------------------------------------------------------
$(TARGET_ELF): $(ALL_OBJS) $(WASM3_LIB) $(INIT_WASM) $(SHELL_WASM) $(TEST_WASM) $(PING6_WASM) $(PLIPCONFIG_WASM) $(RAMDISK_TAR)
	@echo "  LD    $@"
