...
STAT_WASM         = $(MODULES_DIR)/stat/stat.wasm $(MODULES_DIR)/mcookie/mcookie.wasm $(MODULES_DIR)/lsof/lsof.wasm $(MODULES_DIR)/iostat/iostat.wasm $(MODULES_DIR)/vmstat/vmstat.wasm $(MODULES_DIR)/mpstat/mpstat.wasm $(MODULES_DIR)/pidof/pidof.wasm $(MODULES_DIR)/pgrep/pgrep.wasm $(MODULES_DIR)/pkill/pkill.wasm
MCOOKIE_WASM      = $(MODULES_DIR)/mcookie/mcookie.wasm $(MODULES_DIR)/lsof/lsof.wasm $(MODULES_DIR)/iostat/iostat.wasm $(MODULES_DIR)/vmstat/vmstat.wasm $(MODULES_DIR)/mpstat/mpstat.wasm $(MODULES_DIR)/pidof/pidof.wasm $(MODULES_DIR)/pgrep/pgrep.wasm $(MODULES_DIR)/pkill/pkill.wasm
LSOF_WASM         = $(MODULES_DIR)/lsof/lsof.wasm $(MODULES_DIR)/iostat/iostat.wasm $(MODULES_DIR)/vmstat/vmstat.wasm $(MODULES_DIR)/mpstat/mpstat.wasm $(MODULES_DIR)/pidof/pidof.wasm $(MODULES_DIR)/pgrep/pgrep.wasm $(MODULES_DIR)/pkill/pkill.wasm
IOSTAT_WASM       = $(MODULES_DIR)/iostat/iostat.wasm $(MODULES_DIR)/vmstat/vmstat.wasm $(MODULES_DIR)/mpstat/mpstat.wasm $(MODULES_DIR)/pidof/pidof.wasm $(MODULES_DIR)/pgrep/pgrep.wasm $(MODULES_DIR)/pkill/pkill.wasm
VMSTAT_WASM       = $(MODULES_DIR)/vmstat/vmstat.wasm $(MODULES_DIR)/mpstat/mpstat.wasm $(MODULES_DIR)/pidof/pidof.wasm $(MODULES_DIR)/pgrep/pgrep.wasm $(MODULES_DIR)/pkill/pkill.wasm
MPSTAT_WASM       = $(MODULES_DIR)/mpstat/mpstat.wasm $(MODULES_DIR)/pidof/pidof.wasm $(MODULES_DIR)/pgrep/pgrep.wasm $(MODULES_DIR)/pkill/pkill.wasm
PIDOF_WASM        = $(MODULES_DIR)/pidof/pidof.wasm $(MODULES_DIR)/pgrep/pgrep.wasm $(MODULES_DIR)/pkill/pkill.wasm
PGREP_WASM        = $(MODULES_DIR)/pgrep/pgrep.wasm $(MODULES_DIR)/pkill/pkill.wasm
...
$(HASHSUM_WASM): $(MODULES_DIR)/hashsum/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/hashsum.wasm $(KERNEL_DIR)/watch.wasm $(KERNEL_DIR)/wasm_dis.wasm $(KERNEL_DIR)/shred.wasm $(KERNEL_DIR)/stat.wasm $(KERNEL_DIR)/mcookie.wasm $(KERNEL_DIR)/lsof.wasm $(KERNEL_DIR)/iostat.wasm $(KERNEL_DIR)/vmstat.wasm $(KERNEL_DIR)/mpstat.wasm $(KERNEL_DIR)/pidof.wasm $(KERNEL_DIR)/pgrep.wasm $(KERNEL_DIR)/pkill.wasm
...
$(WATCH_WASM): $(MODULES_DIR)/watch/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/watch.wasm $(KERNEL_DIR)/wasm_dis.wasm $(KERNEL_DIR)/shred.wasm $(KERNEL_DIR)/stat.wasm $(KERNEL_DIR)/mcookie.wasm $(KERNEL_DIR)/lsof.wasm $(KERNEL_DIR)/iostat.wasm $(KERNEL_DIR)/vmstat.wasm $(KERNEL_DIR)/mpstat.wasm $(KERNEL_DIR)/pidof.wasm $(KERNEL_DIR)/pgrep.wasm $(KERNEL_DIR)/pkill.wasm
...
$(WASM_DIS_WASM): $(MODULES_DIR)/wasm_dis/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/wasm_dis.wasm $(KERNEL_DIR)/shred.wasm $(KERNEL_DIR)/stat.wasm $(KERNEL_DIR)/mcookie.wasm $(KERNEL_DIR)/lsof.wasm $(KERNEL_DIR)/iostat.wasm $(KERNEL_DIR)/vmstat.wasm $(KERNEL_DIR)/mpstat.wasm $(KERNEL_DIR)/pidof.wasm $(KERNEL_DIR)/pgrep.wasm $(KERNEL_DIR)/pkill.wasm
...
$(SHRED_WASM): $(MODULES_DIR)/shred/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/shred.wasm $(KERNEL_DIR)/stat.wasm $(KERNEL_DIR)/mcookie.wasm $(KERNEL_DIR)/lsof.wasm $(KERNEL_DIR)/iostat.wasm $(KERNEL_DIR)/vmstat.wasm $(KERNEL_DIR)/mpstat.wasm $(KERNEL_DIR)/pidof.wasm $(KERNEL_DIR)/pgrep.wasm $(KERNEL_DIR)/pkill.wasm
...
$(STAT_WASM): $(MODULES_DIR)/stat/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/stat.wasm $(KERNEL_DIR)/mcookie.wasm $(KERNEL_DIR)/lsof.wasm $(KERNEL_DIR)/iostat.wasm $(KERNEL_DIR)/vmstat.wasm $(KERNEL_DIR)/mpstat.wasm $(KERNEL_DIR)/pidof.wasm $(KERNEL_DIR)/pgrep.wasm $(KERNEL_DIR)/pkill.wasm
...
$(MODULES_DIR)/pgrep/pgrep.wasm: $(MODULES_DIR)/pgrep/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/pgrep.wasm $(KERNEL_DIR)/pkill.wasm
