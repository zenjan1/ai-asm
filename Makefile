...
WATCH_WASM        = $(MODULES_DIR)/watch/watch.wasm $(MODULES_DIR)/wasm_dis/wasm_dis.wasm $(MODULES_DIR)/shred/shred.wasm $(MODULES_DIR)/stat/stat.wasm $(MODULES_DIR)/mcookie/mcookie.wasm $(MODULES_DIR)/lsof/lsof.wasm $(MODULES_DIR)/iostat/iostat.wasm $(MODULES_DIR)/vmstat/vmstat.wasm $(MODULES_DIR)/mpstat/mpstat.wasm
WASM_DIS_WASM      = $(MODULES_DIR)/wasm_dis/wasm_dis.wasm $(MODULES_DIR)/shred/shred.wasm $(MODULES_DIR)/stat/stat.wasm $(MODULES_DIR)/mcookie/mcookie.wasm $(MODULES_DIR)/lsof/lsof.wasm $(MODULES_DIR)/iostat/iostat.wasm $(MODULES_DIR)/vmstat/vmstat.wasm $(MODULES_DIR)/mpstat/mpstat.wasm
SHRED_WASM         = $(MODULES_DIR)/shred/shred.wasm $(MODULES_DIR)/stat/stat.wasm $(MODULES_DIR)/mcookie/mcookie.wasm $(MODULES_DIR)/lsof/lsof.wasm $(MODULES_DIR)/iostat/iostat.wasm $(MODULES_DIR)/vmstat/vmstat.wasm $(MODULES_DIR)/mpstat/mpstat.wasm
STAT_WASM         = $(MODULES_DIR)/stat/stat.wasm $(MODULES_DIR)/mcookie/mcookie.wasm $(MODULES_DIR)/lsof/lsof.wasm $(MODULES_DIR)/iostat/iostat.wasm $(MODULES_DIR)/vmstat/vmstat.wasm $(MODULES_DIR)/mpstat/mpstat.wasm
MCOOKIE_WASM      = $(MODULES_DIR)/mcookie/mcookie.wasm $(MODULES_DIR)/lsof/lsof.wasm $(MODULES_DIR)/iostat/iostat.wasm $(MODULES_DIR)/vmstat/vmstat.wasm $(MODULES_DIR)/mpstat/mpstat.wasm
LSOF_WASM         = $(MODULES_DIR)/lsof/lsof.wasm $(MODULES_DIR)/iostat/iostat.wasm $(MODULES_DIR)/vmstat/vmstat.wasm $(MODULES_DIR)/mpstat/mpstat.wasm
IOSTAT_WASM       = $(MODULES_DIR)/iostat/iostat.wasm $(MODULES_DIR)/vmstat/vmstat.wasm $(MODULES_DIR)/mpstat/mpstat.wasm
VMSTAT_WASM       = $(MODULES_DIR)/vmstat/vmstat.wasm $(MODULES_DIR)/mpstat/mpstat.wasm
MPSTAT_WASM       = $(MODULES_DIR)/mpstat/mpstat.wasm
...
$(EXPR_WASM): $(MODULES_DIR)/expr/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/expr.wasm $(KERNEL_DIR)/test_cmd.wasm $(KERNEL_DIR)/dd.wasm $(KERNEL_DIR)/hashsum.wasm $(KERNEL_DIR)/watch.wasm $(KERNEL_DIR)/wasm_dis.wasm $(KERNEL_DIR)/shred.wasm $(KERNEL_DIR)/stat.wasm $(KERNEL_DIR)/mcookie.wasm $(KERNEL_DIR)/lsof.wasm $(KERNEL_DIR)/iostat.wasm $(KERNEL_DIR)/vmstat.wasm $(KERNEL_DIR)/mpstat.wasm
...
$(TEST_CMD_WASM): $(MODULES_DIR)/test_cmd/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/test_cmd.wasm $(KERNEL_DIR)/dd.wasm $(KERNEL_DIR)/hashsum.wasm $(KERNEL_DIR)/watch.wasm $(KERNEL_DIR)/wasm_dis.wasm $(KERNEL_DIR)/shred.wasm $(KERNEL_DIR)/stat.wasm $(KERNEL_DIR)/mcookie.wasm $(KERNEL_DIR)/lsof.wasm $(KERNEL_DIR)/iostat.wasm $(KERNEL_DIR)/vmstat.wasm $(KERNEL_DIR)/mpstat.wasm
...
$(DD_WASM): $(MODULES_DIR)/dd/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/dd.wasm $(KERNEL_DIR)/hashsum.wasm $(KERNEL_DIR)/watch.wasm $(KERNEL_DIR)/wasm_dis.wasm $(KERNEL_DIR)/shred.wasm $(KERNEL_DIR)/stat.wasm $(KERNEL_DIR)/mcookie.wasm $(KERNEL_DIR)/lsof.wasm $(KERNEL_DIR)/iostat.wasm $(KERNEL_DIR)/vmstat.wasm $(KERNEL_DIR)/mpstat.wasm
...
$(HASHSUM_WASM): $(MODULES_DIR)/hashsum/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/hashsum.wasm $(KERNEL_DIR)/watch.wasm $(KERNEL_DIR)/wasm_dis.wasm $(KERNEL_DIR)/shred.wasm $(KERNEL_DIR)/stat.wasm $(KERNEL_DIR)/mcookie.wasm $(KERNEL_DIR)/lsof.wasm $(KERNEL_DIR)/iostat.wasm $(KERNEL_DIR)/vmstat.wasm $(KERNEL_DIR)/mpstat.wasm
...
$(WATCH_WASM): $(MODULES_DIR)/watch/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/watch.wasm $(KERNEL_DIR)/wasm_dis.wasm $(KERNEL_DIR)/shred.wasm $(KERNEL_DIR)/stat.wasm $(KERNEL_DIR)/mcookie.wasm $(KERNEL_DIR)/lsof.wasm $(KERNEL_DIR)/iostat.wasm $(KERNEL_DIR)/vmstat.wasm $(KERNEL_DIR)/mpstat.wasm
...
$(WASM_DIS_WASM): $(MODULES_DIR)/wasm_dis/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/wasm_dis.wasm $(KERNEL_DIR)/shred.wasm $(KERNEL_DIR)/stat.wasm $(KERNEL_DIR)/mcookie.wasm $(KERNEL_DIR)/lsof.wasm $(KERNEL_DIR)/iostat.wasm $(KERNEL_DIR)/vmstat.wasm $(KERNEL_DIR)/mpstat.wasm
...
$(SHRED_WASM): $(MODULES_DIR)/shred/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/shred.wasm $(KERNEL_DIR)/stat.wasm $(KERNEL_DIR)/mcookie.wasm $(KERNEL_DIR)/lsof.wasm $(KERNEL_DIR)/iostat.wasm $(KERNEL_DIR)/vmstat.wasm $(KERNEL_DIR)/mpstat.wasm
...
$(STAT_WASM): $(MODULES_DIR)/stat/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/stat.wasm $(KERNEL_DIR)/mcookie.wasm $(KERNEL_DIR)/lsof.wasm $(KERNEL_DIR)/iostat.wasm $(KERNEL_DIR)/vmstat.wasm $(KERNEL_DIR)/mpstat.wasm
...
$(MODULES_DIR)/vmstat/vmstat.wasm: $(MODULES_DIR)/vmstat/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/vmstat.wasm $(KERNEL_DIR)/mpstat.wasm
