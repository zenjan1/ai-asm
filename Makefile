...
NAMEIF_WASM      = $(MODULES_DIR)/nameif/nameif.wasm $(MODULES_DIR)/plipconfig/plipconfig.wasm $(MODULES_DIR)/pppd/pppd.wasm $(MODULES_DIR)/slattach/slattach.wasm $(MODULES_DIR)/slipattach/slipattach.wasm $(MODULES_DIR)/setkeycodes/setkeycodes.wasm $(MODULES_DIR)/loadkeys/loadkeys.wasm $(MODULES_DIR)/dumpkeys/dumpkeys.wasm
PLIPCONFIG_WASM  = $(MODULES_DIR)/plipconfig/plipconfig.wasm $(MODULES_DIR)/pppd/pppd.wasm $(MODULES_DIR)/slattach/slattach.wasm $(MODULES_DIR)/slipattach/slipattach.wasm $(MODULES_DIR)/setkeycodes/setkeycodes.wasm $(MODULES_DIR)/loadkeys/loadkeys.wasm $(MODULES_DIR)/dumpkeys/dumpkeys.wasm
PPPD_WASM        = $(MODULES_DIR)/pppd/pppd.wasm $(MODULES_DIR)/slattach/slattach.wasm $(MODULES_DIR)/slipattach/slipattach.wasm $(MODULES_DIR)/setkeycodes/setkeycodes.wasm $(MODULES_DIR)/loadkeys/loadkeys.wasm $(MODULES_DIR)/dumpkeys/dumpkeys.wasm
SLATTACH_WASM    = $(MODULES_DIR)/slattach/slattach.wasm $(MODULES_DIR)/slipattach/slipattach.wasm $(MODULES_DIR)/setkeycodes/setkeycodes.wasm $(MODULES_DIR)/loadkeys/loadkeys.wasm $(MODULES_DIR)/dumpkeys/dumpkeys.wasm
SLIPATTACH_WASM  = $(MODULES_DIR)/slipattach/slipattach.wasm $(MODULES_DIR)/setkeycodes/setkeycodes.wasm $(MODULES_DIR)/loadkeys/loadkeys.wasm $(MODULES_DIR)/dumpkeys/dumpkeys.wasm
SETKEYCODES_WASM = $(MODULES_DIR)/setkeycodes/setkeycodes.wasm $(MODULES_DIR)/loadkeys/loadkeys.wasm $(MODULES_DIR)/dumpkeys/dumpkeys.wasm
LOADKEYS_WASM    = $(MODULES_DIR)/loadkeys/loadkeys.wasm $(MODULES_DIR)/dumpkeys/dumpkeys.wasm
DUMPKEYS_WASM    = $(MODULES_DIR)/dumpkeys/dumpkeys.wasm
...
$(LOADKEYS_WASM): $(MODULES_DIR)/loadkeys/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/loadkeys.wasm $(KERNEL_DIR)/dumpkeys.wasm
