...
ENVSUBST_WASM     = $(MODULES_DIR)/envsubst/envsubst.wasm $(MODULES_DIR)/dircolors/dircolors.wasm $(MODULES_DIR)/expr/expr.wasm $(MODULES_DIR)/test_cmd/test_cmd.wasm $(MODULES_DIR)/dd/dd.wasm $(MODULES_DIR)/hashsum/hashsum.wasm $(MODULES_DIR)/watch/watch.wasm $(MODULES_DIR)/wasm_dis/wasm_dis.wasm $(MODULES_DIR)/shred/shred.wasm
DIRCOLORS_WASM    = $(MODULES_DIR)/dircolors/dircolors.wasm $(MODULES_DIR)/expr/expr.wasm $(MODULES_DIR)/test_cmd/test_cmd.wasm $(MODULES_DIR)/dd/dd.wasm $(MODULES_DIR)/hashsum/hashsum.wasm $(MODULES_DIR)/watch/watch.wasm $(MODULES_DIR)/wasm_dis/wasm_dis.wasm $(MODULES_DIR)/shred/shred.wasm
EXPR_WASM         = $(MODULES_DIR)/expr/expr.wasm $(MODULES_DIR)/test_cmd/test_cmd.wasm $(MODULES_DIR)/dd/dd.wasm $(MODULES_DIR)/hashsum/hashsum.wasm $(MODULES_DIR)/watch/watch.wasm $(MODULES_DIR)/wasm_dis/wasm_dis.wasm $(MODULES_DIR)/shred/shred.wasm
TEST_CMD_WASM      = $(MODULES_DIR)/test_cmd/test_cmd.wasm $(MODULES_DIR)/dd/dd.wasm $(MODULES_DIR)/hashsum/hashsum.wasm $(MODULES_DIR)/watch/watch.wasm $(MODULES_DIR)/wasm_dis/wasm_dis.wasm $(MODULES_DIR)/shred/shred.wasm
DD_WASM           = $(MODULES_DIR)/dd/dd.wasm $(MODULES_DIR)/hashsum/hashsum.wasm $(MODULES_DIR)/watch/watch.wasm $(MODULES_DIR)/wasm_dis/wasm_dis.wasm $(MODULES_DIR)/shred/shred.wasm
HASHSUM_WASM      = $(MODULES_DIR)/hashsum/hashsum.wasm $(MODULES_DIR)/watch/watch.wasm $(MODULES_DIR)/wasm_dis/wasm_dis.wasm $(MODULES_DIR)/shred/shred.wasm
WATCH_WASM        = $(MODULES_DIR)/watch/watch.wasm $(MODULES_DIR)/wasm_dis/wasm_dis.wasm $(MODULES_DIR)/shred/shred.wasm
WASM_DIS_WASM      = $(MODULES_DIR)/wasm_dis/wasm_dis.wasm $(MODULES_DIR)/shred/shred.wasm
SHRED_WASM         = $(MODULES_DIR)/shred/shred.wasm
...
$(MKTEMP_WASM): $(MODULES_DIR)/mktemp/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/mktemp.wasm $(KERNEL_DIR)/truncate.wasm $(KERNEL_DIR)/nohup.wasm $(KERNEL_DIR)/envsubst.wasm $(KERNEL_DIR)/dircolors.wasm $(KERNEL_DIR)/expr.wasm $(KERNEL_DIR)/test_cmd.wasm $(KERNEL_DIR)/dd.wasm $(KERNEL_DIR)/hashsum.wasm $(KERNEL_DIR)/watch.wasm $(KERNEL_DIR)/wasm_dis.wasm $(KERNEL_DIR)/shred.wasm
...
$(TRUNCATE_WASM): $(MODULES_DIR)/truncate/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/truncate.wasm $(KERNEL_DIR)/nohup.wasm $(KERNEL_DIR)/envsubst.wasm $(KERNEL_DIR)/dircolors.wasm $(KERNEL_DIR)/expr.wasm $(KERNEL_DIR)/test_cmd.wasm $(KERNEL_DIR)/dd.wasm $(KERNEL_DIR)/hashsum.wasm $(KERNEL_DIR)/watch.wasm $(KERNEL_DIR)/wasm_dis.wasm $(KERNEL_DIR)/shred.wasm
...
$(NOHUP_WASM): $(MODULES_DIR)/nohup/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/nohup.wasm $(KERNEL_DIR)/envsubst.wasm $(KERNEL_DIR)/dircolors.wasm $(KERNEL_DIR)/expr.wasm $(KERNEL_DIR)/test_cmd.wasm $(KERNEL_DIR)/dd.wasm $(KERNEL_DIR)/hashsum.wasm $(KERNEL_DIR)/watch.wasm $(KERNEL_DIR)/wasm_dis.wasm $(KERNEL_DIR)/shred.wasm
...
$(ENVSUBST_WASM): $(MODULES_DIR)/envsubst/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/envsubst.wasm $(KERNEL_DIR)/dircolors.wasm $(KERNEL_DIR)/expr.wasm $(KERNEL_DIR)/test_cmd.wasm $(KERNEL_DIR)/dd.wasm $(KERNEL_DIR)/hashsum.wasm $(KERNEL_DIR)/watch.wasm $(KERNEL_DIR)/wasm_dis.wasm $(KERNEL_DIR)/shred.wasm
...
$(DIRCOLORS_WASM): $(MODULES_DIR)/dircolors/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/dircolors.wasm $(KERNEL_DIR)/expr.wasm $(KERNEL_DIR)/test_cmd.wasm $(KERNEL_DIR)/dd.wasm $(KERNEL_DIR)/hashsum.wasm $(KERNEL_DIR)/watch.wasm $(KERNEL_DIR)/wasm_dis.wasm $(KERNEL_DIR)/shred.wasm
...
$(EXPR_WASM): $(MODULES_DIR)/expr/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/expr.wasm $(KERNEL_DIR)/test_cmd.wasm $(KERNEL_DIR)/dd.wasm $(KERNEL_DIR)/hashsum.wasm $(KERNEL_DIR)/watch.wasm $(KERNEL_DIR)/wasm_dis.wasm $(KERNEL_DIR)/shred.wasm
...
$(TEST_CMD_WASM): $(MODULES_DIR)/test_cmd/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/test_cmd.wasm $(KERNEL_DIR)/dd.wasm $(KERNEL_DIR)/hashsum.wasm $(KERNEL_DIR)/watch.wasm $(KERNEL_DIR)/wasm_dis.wasm $(KERNEL_DIR)/shred.wasm
...
$(DD_WASM): $(MODULES_DIR)/dd/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/dd.wasm $(KERNEL_DIR)/hashsum.wasm $(KERNEL_DIR)/watch.wasm $(KERNEL_DIR)/wasm_dis.wasm $(KERNEL_DIR)/shred.wasm
...
$(HASHSUM_WASM): $(MODULES_DIR)/hashsum/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/hashsum.wasm $(KERNEL_DIR)/watch.wasm $(KERNEL_DIR)/wasm_dis.wasm $(KERNEL_DIR)/shred.wasm
...
$(WATCH_WASM): $(MODULES_DIR)/watch/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/watch.wasm $(KERNEL_DIR)/wasm_dis.wasm $(KERNEL_DIR)/shred.wasm
...
$(WASM_DIS_WASM): $(MODULES_DIR)/wasm_dis/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/wasm_dis.wasm $(KERNEL_DIR)/shred.wasm
