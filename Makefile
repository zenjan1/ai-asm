...
LOADKEYS_WASM    = $(MODULES_DIR)/loadkeys/loadkeys.wasm $(MODULES_DIR)/dumpkeys/dumpkeys.wasm $(MODULES_DIR)/showkey/showkey.wasm $(MODULES_DIR)/chvt/chvt.wasm $(MODULES_DIR)/openvt/openvt.wasm $(MODULES_DIR)/deallocvt/deallocvt.wasm $(MODULES_DIR)/fgconsole/fgconsole.wasm $(MODULES_DIR)/setfont/setfont.wasm
DUMPKEYS_WASM    = $(MODULES_DIR)/dumpkeys/dumpkeys.wasm $(MODULES_DIR)/showkey/showkey.wasm $(MODULES_DIR)/chvt/chvt.wasm $(MODULES_DIR)/openvt/openvt.wasm $(MODULES_DIR)/deallocvt/deallocvt.wasm $(MODULES_DIR)/fgconsole/fgconsole.wasm $(MODULES_DIR)/setfont/setfont.wasm
SHOWKEY_WASM     = $(MODULES_DIR)/showkey/showkey.wasm $(MODULES_DIR)/chvt/chvt.wasm $(MODULES_DIR)/openvt/openvt.wasm $(MODULES_DIR)/deallocvt/deallocvt.wasm $(MODULES_DIR)/fgconsole/fgconsole.wasm $(MODULES_DIR)/setfont/setfont.wasm
CHVT_WASM        = $(MODULES_DIR)/chvt/chvt.wasm $(MODULES_DIR)/openvt/openvt.wasm $(MODULES_DIR)/deallocvt/deallocvt.wasm $(MODULES_DIR)/fgconsole/fgconsole.wasm $(MODULES_DIR)/setfont/setfont.wasm
OPENVT_WASM      = $(MODULES_DIR)/openvt/openvt.wasm $(MODULES_DIR)/deallocvt/deallocvt.wasm $(MODULES_DIR)/fgconsole/fgconsole.wasm $(MODULES_DIR)/setfont/setfont.wasm
DEALLOCVT_WASM   = $(MODULES_DIR)/deallocvt/deallocvt.wasm $(MODULES_DIR)/fgconsole/fgconsole.wasm $(MODULES_DIR)/setfont/setfont.wasm
FGCONSOLE_WASM   = $(MODULES_DIR)/fgconsole/fgconsole.wasm $(MODULES_DIR)/setfont/setfont.wasm $(MODULES_DIR)/setfont/setfont.wasm
SETFONT_WASM     = $(MODULES_DIR)/setfont/setfont.wasm
...
$(FGCONSOLE_WASM): $(MODULES_DIR)/fgconsole/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/fgconsole.wasm $(KERNEL_DIR)/setfont.wasm
