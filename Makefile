...
PKILL_WASM        = $(MODULES_DIR)/pkill/pkill.wasm $(MODULES_DIR)/top/top.wasm $(MODULES_DIR)/htop/htop.wasm $(MODULES_DIR)/strace/strace.wasm $(MODULES_DIR)/ltrace/ltrace.wasm $(MODULES_DIR)/tracepath/tracepath.wasm $(MODULES_DIR)/ss/ss.wasm $(MODULES_DIR)/ip/ip.wasm $(MODULES_DIR)/killall/killall.wasm $(MODULES_DIR)/nmap/nmap.wasm
TOP_WASM         = $(MODULES_DIR)/top/top.wasm $(MODULES_DIR)/htop/htop.wasm $(MODULES_DIR)/strace/strace.wasm $(MODULES_DIR)/ltrace/ltrace.wasm $(MODULES_DIR)/tracepath/tracepath.wasm $(MODULES_DIR)/ss/ss.wasm $(MODULES_DIR)/ip/ip.wasm $(MODULES_DIR)/killall/killall.wasm $(MODULES_DIR)/nmap/nmap.wasm
HTOP_WASM        = $(MODULES_DIR)/htop/htop.wasm $(MODULES_DIR)/strace/strace.wasm $(MODULES_DIR)/ltrace/ltrace.wasm $(MODULES_DIR)/tracepath/tracepath.wasm $(MODULES_DIR)/ss/ss.wasm $(MODULES_DIR)/ip/ip.wasm $(MODULES_DIR)/killall/killall.wasm $(MODULES_DIR)/nmap/nmap.wasm
STRACE_WASM       = $(MODULES_DIR)/strace/strace.wasm $(MODULES_DIR)/ltrace/ltrace.wasm $(MODULES_DIR)/tracepath/tracepath.wasm $(MODULES_DIR)/ss/ss.wasm $(MODULES_DIR)/ip/ip.wasm $(MODULES_DIR)/killall/killall.wasm $(MODULES_DIR)/nmap/nmap.wasm
LTRACE_WASM       = $(MODULES_DIR)/ltrace/ltrace.wasm $(MODULES_DIR)/tracepath/tracepath.wasm $(MODULES_DIR)/ss/ss.wasm $(MODULES_DIR)/ip/ip.wasm $(MODULES_DIR)/killall/killall.wasm $(MODULES_DIR)/nmap/nmap.wasm
TRACEPATH_WASM    = $(MODULES_DIR)/tracepath/tracepath.wasm $(MODULES_DIR)/ss/ss.wasm $(MODULES_DIR)/ip/ip.wasm $(MODULES_DIR)/killall/killall.wasm $(MODULES_DIR)/nmap/nmap.wasm
SS_WASM          = $(MODULES_DIR)/ss/ss.wasm $(MODULES_DIR)/ip/ip.wasm $(MODULES_DIR)/killall/killall.wasm $(MODULES_DIR)/nmap/nmap.wasm $(MODULES_DIR)/nmap/nmap.wasm
IP_WASM          = $(MODULES_DIR)/ip/ip.wasm $(MODULES_DIR)/killall/killall.wasm $(MODULES_DIR)/nmap/nmap.wasm $(MODULES_DIR)/nmap/nmap.wasm
KILLALL_WASM     = $(MODULES_DIR)/killall/killall.wasm $(MODULES_DIR)/nmap/nmap.wasm $(MODULES_DIR)/nmap/nmap.wasm
NMAP_WASM        = $(MODULES_DIR)/nmap/nmap.wasm
...
$(MODULES_DIR)/ip/ip.wasm $(MODULES_DIR)/killall/killall.wasm $(MODULES_DIR)/nmap/nmap.wasm: $(MODULES_DIR)/ip/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/ip.wasm

$(MODULES_DIR)/killall/killall.wasm $(MODULES_DIR)/nmap/nmap.wasm: $(MODULES_DIR)/killall/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/killall.wasm

$(MODULES_DIR)/nmap/nmap.wasm: $(MODULES_DIR)/nmap/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
