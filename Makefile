...
SS_WASM          = $(MODULES_DIR)/ss/ss.wasm $(MODULES_DIR)/ip/ip.wasm $(MODULES_DIR)/killall/killall.wasm $(MODULES_DIR)/nmap/nmap.wasm $(MODULES_DIR)/tar/tar.wasm $(MODULES_DIR)/dig/dig.wasm $(MODULES_DIR)/host/host.wasm $(MODULES_DIR)/arp/arp.wasm $(MODULES_DIR)/iwconfig/iwconfig.wasm $(MODULES_DIR)/ifup/ifup.wasm $(MODULES_DIR)/nmap/nmap.wasm $(MODULES_DIR)/tar/tar.wasm $(MODULES_DIR)/dig/dig.wasm $(MODULES_DIR)/host/host.wasm $(MODULES_DIR)/arp/arp.wasm $(MODULES_DIR)/iwconfig/iwconfig.wasm $(MODULES_DIR)/ifup/ifup.wasm
IP_WASM          = $(MODULES_DIR)/ip/ip.wasm $(MODULES_DIR)/killall/killall.wasm $(MODULES_DIR)/nmap/nmap.wasm $(MODULES_DIR)/tar/tar.wasm $(MODULES_DIR)/dig/dig.wasm $(MODULES_DIR)/host/host.wasm $(MODULES_DIR)/arp/arp.wasm $(MODULES_DIR)/iwconfig/iwconfig.wasm $(MODULES_DIR)/ifup/ifup.wasm
KILLALL_WASM     = $(MODULES_DIR)/killall/killall.wasm $(MODULES_DIR)/nmap/nmap.wasm $(MODULES_DIR)/tar/tar.wasm $(MODULES_DIR)/dig/dig.wasm $(MODULES_DIR)/host/host.wasm $(MODULES_DIR)/arp/arp.wasm $(MODULES_DIR)/iwconfig/iwconfig.wasm $(MODULES_DIR)/ifup/ifup.wasm
NMAP_WASM        = $(MODULES_DIR)/nmap/nmap.wasm $(MODULES_DIR)/tar/tar.wasm $(MODULES_DIR)/dig/dig.wasm $(MODULES_DIR)/host/host.wasm $(MODULES_DIR)/arp/arp.wasm $(MODULES_DIR)/iwconfig/iwconfig.wasm $(MODULES_DIR)/ifup/ifup.wasm
TAR_WASM         = $(MODULES_DIR)/tar/tar.wasm $(MODULES_DIR)/dig/dig.wasm $(MODULES_DIR)/host/host.wasm $(MODULES_DIR)/arp/arp.wasm $(MODULES_DIR)/iwconfig/iwconfig.wasm $(MODULES_DIR)/ifup/ifup.wasm $(MODULES_DIR)/dig/dig.wasm $(MODULES_DIR)/host/host.wasm $(MODULES_DIR)/arp/arp.wasm $(MODULES_DIR)/iwconfig/iwconfig.wasm $(MODULES_DIR)/ifup/ifup.wasm
DIG_WASM         = $(MODULES_DIR)/dig/dig.wasm $(MODULES_DIR)/host/host.wasm $(MODULES_DIR)/arp/arp.wasm $(MODULES_DIR)/iwconfig/iwconfig.wasm $(MODULES_DIR)/ifup/ifup.wasm $(MODULES_DIR)/host/host.wasm $(MODULES_DIR)/arp/arp.wasm $(MODULES_DIR)/iwconfig/iwconfig.wasm $(MODULES_DIR)/ifup/ifup.wasm
HOST_CMD_WASM    = $(MODULES_DIR)/host/host.wasm $(MODULES_DIR)/arp/arp.wasm $(MODULES_DIR)/iwconfig/iwconfig.wasm $(MODULES_DIR)/ifup/ifup.wasm $(MODULES_DIR)/arp/arp.wasm $(MODULES_DIR)/iwconfig/iwconfig.wasm $(MODULES_DIR)/ifup/ifup.wasm
ARP_WASM         = $(MODULES_DIR)/arp/arp.wasm $(MODULES_DIR)/iwconfig/iwconfig.wasm $(MODULES_DIR)/ifup/ifup.wasm $(MODULES_DIR)/iwconfig/iwconfig.wasm $(MODULES_DIR)/ifup/ifup.wasm
IWCONFIG_WASM    = $(MODULES_DIR)/iwconfig/iwconfig.wasm $(MODULES_DIR)/ifup/ifup.wasm $(MODULES_DIR)/ifup/ifup.wasm
IFUP_WASM        = $(MODULES_DIR)/ifup/ifup.wasm
...
# ---------------------------------------------------------------------------
$(IFUP_WASM) $(RAMDISK_TAR): ramdisk/motd.txt ramdisk/hello.txt ramdisk/readme.txt
	@echo "  TAR   $@"
...
$(MODULES_DIR)/ip/ip.wasm $(MODULES_DIR)/killall/killall.wasm $(MODULES_DIR)/nmap/nmap.wasm $(MODULES_DIR)/tar/tar.wasm $(MODULES_DIR)/dig/dig.wasm $(MODULES_DIR)/host/host.wasm $(MODULES_DIR)/arp/arp.wasm $(MODULES_DIR)/iwconfig/iwconfig.wasm $(MODULES_DIR)/ifup/ifup.wasm: $(MODULES_DIR)/ip/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/ip.wasm

$(MODULES_DIR)/killall/killall.wasm $(MODULES_DIR)/nmap/nmap.wasm $(MODULES_DIR)/tar/tar.wasm $(MODULES_DIR)/dig/dig.wasm $(MODULES_DIR)/host/host.wasm $(MODULES_DIR)/arp/arp.wasm $(MODULES_DIR)/iwconfig/iwconfig.wasm $(MODULES_DIR)/ifup/ifup.wasm: $(MODULES_DIR)/killall/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/killall.wasm

$(MODULES_DIR)/nmap/nmap.wasm $(MODULES_DIR)/tar/tar.wasm $(MODULES_DIR)/dig/dig.wasm $(MODULES_DIR)/host/host.wasm $(MODULES_DIR)/arp/arp.wasm $(MODULES_DIR)/iwconfig/iwconfig.wasm $(MODULES_DIR)/ifup/ifup.wasm: $(MODULES_DIR)/nmap/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/nmap.wasm

$(MODULES_DIR)/tar/tar.wasm $(MODULES_DIR)/dig/dig.wasm $(MODULES_DIR)/host/host.wasm $(MODULES_DIR)/arp/arp.wasm $(MODULES_DIR)/iwconfig/iwconfig.wasm $(MODULES_DIR)/ifup/ifup.wasm: $(MODULES_DIR)/tar/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/tar.wasm

$(MODULES_DIR)/dig/dig.wasm $(MODULES_DIR)/host/host.wasm $(MODULES_DIR)/arp/arp.wasm $(MODULES_DIR)/iwconfig/iwconfig.wasm $(MODULES_DIR)/ifup/ifup.wasm: $(MODULES_DIR)/dig/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/dig.wasm

$(MODULES_DIR)/host/host.wasm $(MODULES_DIR)/arp/arp.wasm $(MODULES_DIR)/iwconfig/iwconfig.wasm $(MODULES_DIR)/ifup/ifup.wasm: $(MODULES_DIR)/host/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/host.wasm

$(MODULES_DIR)/arp/arp.wasm $(MODULES_DIR)/iwconfig/iwconfig.wasm $(MODULES_DIR)/ifup/ifup.wasm: $(MODULES_DIR)/arp/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/arp.wasm

$(MODULES_DIR)/iwconfig/iwconfig.wasm $(MODULES_DIR)/ifup/ifup.wasm: $(MODULES_DIR)/iwconfig/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/iwconfig.wasm

$(MODULES_DIR)/ifup/ifup.wasm: $(MODULES_DIR)/ifup/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
...
# Full kernel link
# ---------------------------------------------------------------------------
$(TARGET_ELF): $(ALL_OBJS) $(WASM3_LIB) $(INIT_WASM) $(SHELL_WASM) $(TEST_WASM) $(IFUP_WASM) $(RAMDISK_TAR)
	@echo "  LD    $@"
