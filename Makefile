...
PATHCHK_WASM      = $(MODULES_DIR)/pathchk/pathchk.wasm $(MODULES_DIR)/mktemp/mktemp.wasm $(MODULES_DIR)/truncate/truncate.wasm $(MODULES_DIR)/nohup/nohup.wasm $(MODULES_DIR)/envsubst/envsubst.wasm $(MODULES_DIR)/dircolors/dircolors.wasm $(MODULES_DIR)/expr/expr.wasm $(MODULES_DIR)/test_cmd/test_cmd.wasm
MKTEMP_WASM       = $(MODULES_DIR)/mktemp/mktemp.wasm $(MODULES_DIR)/truncate/truncate.wasm $(MODULES_DIR)/nohup/nohup.wasm $(MODULES_DIR)/envsubst/envsubst.wasm $(MODULES_DIR)/dircolors/dircolors.wasm $(MODULES_DIR)/expr/expr.wasm $(MODULES_DIR)/test_cmd/test_cmd.wasm
TRUNCATE_WASM      = $(MODULES_DIR)/truncate/truncate.wasm $(MODULES_DIR)/nohup/nohup.wasm $(MODULES_DIR)/envsubst/envsubst.wasm $(MODULES_DIR)/dircolors/dircolors.wasm $(MODULES_DIR)/expr/expr.wasm $(MODULES_DIR)/test_cmd/test_cmd.wasm
NOHUP_WASM         = $(MODULES_DIR)/nohup/nohup.wasm $(MODULES_DIR)/envsubst/envsubst.wasm $(MODULES_DIR)/dircolors/dircolors.wasm $(MODULES_DIR)/expr/expr.wasm $(MODULES_DIR)/test_cmd/test_cmd.wasm
ENVSUBST_WASM     = $(MODULES_DIR)/envsubst/envsubst.wasm $(MODULES_DIR)/dircolors/dircolors.wasm $(MODULES_DIR)/expr/expr.wasm $(MODULES_DIR)/test_cmd/test_cmd.wasm
DIRCOLORS_WASM    = $(MODULES_DIR)/dircolors/dircolors.wasm $(MODULES_DIR)/expr/expr.wasm $(MODULES_DIR)/test_cmd/test_cmd.wasm
EXPR_WASM         = $(MODULES_DIR)/expr/expr.wasm $(MODULES_DIR)/test_cmd/test_cmd.wasm
...
$(SEQ_WASM): $(MODULES_DIR)/seq/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/seq.wasm $(KERNEL_DIR)/realpath.wasm $(KERNEL_DIR)/groups.wasm $(KERNEL_DIR)/install.wasm $(KERNEL_DIR)/pathchk.wasm $(KERNEL_DIR)/mktemp.wasm $(KERNEL_DIR)/truncate.wasm $(KERNEL_DIR)/nohup.wasm $(KERNEL_DIR)/envsubst.wasm $(KERNEL_DIR)/dircolors.wasm $(KERNEL_DIR)/expr.wasm $(KERNEL_DIR)/test_cmd.wasm
...
$(REALPATH_WASM): $(MODULES_DIR)/realpath/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/realpath.wasm $(KERNEL_DIR)/groups.wasm $(KERNEL_DIR)/install.wasm $(KERNEL_DIR)/pathchk.wasm $(KERNEL_DIR)/mktemp.wasm $(KERNEL_DIR)/truncate.wasm $(KERNEL_DIR)/nohup.wasm $(KERNEL_DIR)/envsubst.wasm $(KERNEL_DIR)/dircolors.wasm $(KERNEL_DIR)/expr.wasm $(KERNEL_DIR)/test_cmd.wasm
...
$(GROUPS_WASM): $(MODULES_DIR)/groups/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/groups.wasm $(KERNEL_DIR)/install.wasm $(KERNEL_DIR)/pathchk.wasm $(KERNEL_DIR)/mktemp.wasm $(KERNEL_DIR)/truncate.wasm $(KERNEL_DIR)/nohup.wasm $(KERNEL_DIR)/envsubst.wasm $(KERNEL_DIR)/dircolors.wasm $(KERNEL_DIR)/expr.wasm $(KERNEL_DIR)/test_cmd.wasm
...
$(INSTALL_WASM): $(MODULES_DIR)/install/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/install.wasm $(KERNEL_DIR)/pathchk.wasm $(KERNEL_DIR)/mktemp.wasm $(KERNEL_DIR)/truncate.wasm $(KERNEL_DIR)/nohup.wasm $(KERNEL_DIR)/envsubst.wasm $(KERNEL_DIR)/dircolors.wasm $(KERNEL_DIR)/expr.wasm $(KERNEL_DIR)/test_cmd.wasm
...
$(PATHCHK_WASM): $(MODULES_DIR)/pathchk/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/pathchk.wasm $(KERNEL_DIR)/mktemp.wasm $(KERNEL_DIR)/truncate.wasm $(KERNEL_DIR)/nohup.wasm $(KERNEL_DIR)/envsubst.wasm $(KERNEL_DIR)/dircolors.wasm $(KERNEL_DIR)/expr.wasm $(KERNEL_DIR)/test_cmd.wasm
...
$(MKTEMP_WASM): $(MODULES_DIR)/mktemp/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/mktemp.wasm $(KERNEL_DIR)/truncate.wasm $(KERNEL_DIR)/nohup.wasm $(KERNEL_DIR)/envsubst.wasm $(KERNEL_DIR)/dircolors.wasm $(KERNEL_DIR)/expr.wasm $(KERNEL_DIR)/test_cmd.wasm
