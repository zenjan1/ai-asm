...
GZIP_WASM       = $(MODULES_DIR)/gzip/gzip.wasm $(MODULES_DIR)/gunzip/gunzip.wasm $(MODULES_DIR)/zcat/zcat.wasm $(MODULES_DIR)/bzip2/bzip2.wasm $(MODULES_DIR)/bunzip2/bunzip2.wasm $(MODULES_DIR)/lzma/lzma.wasm $(MODULES_DIR)/unlzma/unlzma.wasm $(MODULES_DIR)/xz/xz.wasm
...
XZ_WASM         = $(MODULES_DIR)/xz/xz.wasm
...
clean:
	...
	rm -f $(KERNEL_DIR)/gzip.wasm $(KERNEL_DIR)/gunzip.wasm $(KERNEL_DIR)/zcat.wasm $(KERNEL_DIR)/bzip2.wasm $(KERNEL_DIR)/bunzip2.wasm $(KERNEL_DIR)/lzma.wasm $(KERNEL_DIR)/unlzma.wasm $(KERNEL_DIR)/xz.wasm $(KERNEL_DIR)/unxz.wasm $(KERNEL_DIR)/sha256sum.wasm $(KERNEL_DIR)/md5sum.wasm $(KERNEL_DIR)/base64.wasm $(KERNEL_DIR)/base64d.wasm $(KERNEL_DIR)/od.wasm $(KERNEL_DIR)/hexdump.wasm $(KERNEL_DIR)/strings.wasm $(KERNEL_DIR)/file.wasm $(KERNEL_DIR)/xxd.wasm $(KERNEL_DIR)/less.wasm $(KERNEL_DIR)/more.wasm $(KERNEL_DIR)/join.wasm $(KERNEL_DIR)/split.wasm $(KERNEL_DIR)/patch.wasm $(KERNEL_DIR)/diff3.wasm $(KERNEL_DIR)/tsort.wasm $(KERNEL_DIR)/csplit.wasm $(KERNEL_DIR)/fmt.wasm
