...
PING6_WASM       = $(MODULES_DIR)/ping6/ping6.wasm $(MODULES_DIR)/ethtool/ethtool.wasm $(MODULES_DIR)/arping/arping.wasm $(MODULES_DIR)/brctl/brctl.wasm $(MODULES_DIR)/ifstat/ifstat.wasm $(MODULES_DIR)/mii_tool/mii_tool.wasm
ETHTOOL_WASM     = $(MODULES_DIR)/ethtool/ethtool.wasm $(MODULES_DIR)/arping/arping.wasm $(MODULES_DIR)/brctl/brctl.wasm $(MODULES_DIR)/ifstat/ifstat.wasm $(MODULES_DIR)/mii_tool/mii_tool.wasm
ARPING_WASM      = $(MODULES_DIR)/arping/arping.wasm $(MODULES_DIR)/brctl/brctl.wasm $(MODULES_DIR)/ifstat/ifstat.wasm $(MODULES_DIR)/mii_tool/mii_tool.wasm
BRCTL_WASM       = $(MODULES_DIR)/brctl/brctl.wasm $(MODULES_DIR)/ifstat/ifstat.wasm $(MODULES_DIR)/mii_tool/mii_tool.wasm
IFSTAT_WASM      = $(MODULES_DIR)/ifstat/ifstat.wasm $(MODULES_DIR)/mii_tool/mii_tool.wasm
MII_TOOL_WASM    = $(MODULES_DIR)/mii_tool/mii_tool.wasm
...
# ---------------------------------------------------------------------------
$(PING6_WASM) $(ETHTOOL_WASM) $(ARPING_WASM) $(BRCTL_WASM) $(IFSTAT_WASM) $(MII_TOOL_WASM) $(RAMDISK_TAR): ramdisk/motd.txt ramdisk/hello.txt ramdisk/readme.txt
	@echo "  TAR   $@"
...
# Full kernel link
# ---------------------------------------------------------------------------
$(TARGET_ELF): $(ALL_OBJS) $(WASM3_LIB) $(INIT_WASM) $(SHELL_WASM) $(TEST_WASM) $(PING6_WASM) $(MII_TOOL_WASM) $(RAMDISK_TAR)
	@echo "  LD    $@"
