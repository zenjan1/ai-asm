...
PIDOF_WASM        = $(MODULES_DIR)/pidof/pidof.wasm $(MODULES_DIR)/pgrep/pgrep.wasm $(MODULES_DIR)/pkill/pkill.wasm $(MODULES_DIR)/top/top.wasm $(MODULES_DIR)/htop/htop.wasm $(MODULES_DIR)/strace/strace.wasm $(MODULES_DIR)/ltrace/ltrace.wasm $(MODULES_DIR)/tracepath/tracepath.wasm $(MODULES_DIR)/ss/ss.wasm
PGREP_WASM        = $(MODULES_DIR)/pgrep/pgrep.wasm $(MODULES_DIR)/pkill/pkill.wasm $(MODULES_DIR)/top/top.wasm $(MODULES_DIR)/htop/htop.wasm $(MODULES_DIR)/strace/strace.wasm $(MODULES_DIR)/ltrace/ltrace.wasm $(MODULES_DIR)/tracepath/tracepath.wasm $(MODULES_DIR)/ss/ss.wasm
PKILL_WASM        = $(MODULES_DIR)/pkill/pkill.wasm $(MODULES_DIR)/top/top.wasm $(MODULES_DIR)/htop/htop.wasm $(MODULES_DIR)/strace/strace.wasm $(MODULES_DIR)/ltrace/ltrace.wasm $(MODULES_DIR)/tracepath/tracepath.wasm $(MODULES_DIR)/ss/ss.wasm
TOP_WASM         = $(MODULES_DIR)/top/top.wasm $(MODULES_DIR)/htop/htop.wasm $(MODULES_DIR)/strace/strace.wasm $(MODULES_DIR)/ltrace/ltrace.wasm $(MODULES_DIR)/tracepath/tracepath.wasm $(MODULES_DIR)/ss/ss.wasm
HTOP_WASM        = $(MODULES_DIR)/htop/htop.wasm $(MODULES_DIR)/strace/strace.wasm $(MODULES_DIR)/ltrace/ltrace.wasm $(MODULES_DIR)/tracepath/tracepath.wasm $(MODULES_DIR)/ss/ss.wasm
STRACE_WASM       = $(MODULES_DIR)/strace/strace.wasm $(MODULES_DIR)/ltrace/ltrace.wasm $(MODULES_DIR)/tracepath/tracepath.wasm $(MODULES_DIR)/ss/ss.wasm
LTRACE_WASM       = $(MODULES_DIR)/ltrace/ltrace.wasm $(MODULES_DIR)/tracepath/tracepath.wasm $(MODULES_DIR)/ss/ss.wasm
TRACEPATH_WASM    = $(MODULES_DIR)/tracepath/tracepath.wasm $(MODULES_DIR)/ss/ss.wasm
SS_WASM          = $(MODULES_DIR)/ss/ss.wasm
...
$(MODULES_DIR)/tracepath/tracepath.wasm: $(MODULES_DIR)/tracepath/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/tracepath.wasm $(KERNEL_DIR)/ss.wasm
