...
DEALLOCVT_V12_WASM = $(MODULES_DIR)/deallocvt_v12/deallocvt_v12.wasm
FGCONSOLE_V12_WASM = $(MODULES_DIR)/fgconsole_v12/fgconsole_v12.wasm
KBD_MODE_V12_WASM = $(MODULES_DIR)/kbd_mode_v12/kbd_mode_v12.wasm
DUMPKEYS_V13_WASM = $(MODULES_DIR)/dumpkeys_v13/dumpkeys_v13.wasm
UNICODE_START_V12_WASM = $(MODULES_DIR)/unicode_start_v12/unicode_start_v12.wasm
MAPSCRN_V12_WASM = $(MODULES_DIR)/mapscrn_v12/mapscrn_v12.wasm
SETMETAMODE_V12_WASM = $(MODULES_DIR)/setmetamode_v12/setmetamode_v12.wasm
DUMPKEYS_V14_WASM = $(MODULES_DIR)/dumpkeys_v14/dumpkeys_v14.wasm
SETKEYCODES_V12_WASM = $(MODULES_DIR)/setkeycodes_v12/setkeycodes_v12.wasm
DUMPKEYS_V15_WASM = $(MODULES_DIR)/dumpkeys_v15/dumpkeys_v15.wasm
SHOWKEY_V12_WASM = $(MODULES_DIR)/showkey_v12/showkey_v12.wasm
OPENVT_V13_WASM = $(MODULES_DIR)/openvt_v13/openvt_v13.wasm
KBD_MODE_V13_WASM = $(MODULES_DIR)/kbd_mode_v13/kbd_mode_v13.wasm
FGCONSOLE_V13_WASM = $(MODULES_DIR)/fgconsole_v13/fgconsole_v13.wasm
SETFONT_V13_WASM = $(MODULES_DIR)/setfont_v13/setfont_v13.wasm
KBD_MODE_V14_WASM = $(MODULES_DIR)/kbd_mode_v14/kbd_mode_v14.wasm
FGCONSOLE_V14_WASM = $(MODULES_DIR)/fgconsole_v14/fgconsole_v14.wasm
SETFONT_V14_WASM = $(MODULES_DIR)/setfont_v14/setfont_v14.wasm
KBD_MODE_V15_WASM = $(MODULES_DIR)/kbd_mode_v15/kbd_mode_v15.wasm
FGCONSOLE_V15_WASM = $(MODULES_DIR)/fgconsole_v15/fgconsole_v15.wasm
SETFONT_V15_WASM = $(MODULES_DIR)/setfont_v15/setfont_v15.wasm
KBD_MODE_V16_WASM = $(MODULES_DIR)/kbd_mode_v16/kbd_mode_v16.wasm
FGCONSOLE_V16_WASM = $(MODULES_DIR)/fgconsole_v16/fgconsole_v16.wasm
SETFONT_V16_WASM = $(MODULES_DIR)/setfont_v16/setfont_v16.wasm
DUMPKEYS_V7_WASM = $(MODULES_DIR)/dumpkeys_v7/dumpkeys_v7.wasm
UNICODE_START_V7_WASM = $(MODULES_DIR)/unicode_start_v7/unicode_start_v7.wasm
MAPSCRN_V7_WASM = $(MODULES_DIR)/mapscrn_v7/mapscrn_v7.wasm
SETKEYCODES_V7_WASM = $(MODULES_DIR)/setkeycodes_v7/setkeycodes_v7.wasm
SETMETAMODE_V7_WASM = $(MODULES_DIR)/setmetamode_v7/setmetamode_v7.wasm
UNICODE_STOP_V7_WASM = $(MODULES_DIR)/unicode_stop_v7/unicode_stop_v7.wasm
CAT_V7_WASM = $(MODULES_DIR)/cat_v7/cat_v7.wasm
DATE_V7_WASM = $(MODULES_DIR)/date_v7/date_v7.wasm
WC_V7_WASM = $(MODULES_DIR)/wc_v7/wc_v7.wasm
TAIL_V7_WASM = $(MODULES_DIR)/tail_v7/tail_v7.wasm
UNIQ_V7_WASM = $(MODULES_DIR)/uniq_v7/uniq_v7.wasm
...
# ---------------------------------------------------------------------------
$(DEALLOCVT_V12_WASM): $(MODULES_DIR)/deallocvt_v12/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/deallocvt_v12.wasm

# ---------------------------------------------------------------------------
$(FGCONSOLE_V12_WASM): $(MODULES_DIR)/fgconsole_v12/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/fgconsole_v12.wasm

# ---------------------------------------------------------------------------
$(KBD_MODE_V12_WASM): $(MODULES_DIR)/kbd_mode_v12/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/kbd_mode_v12.wasm

# ---------------------------------------------------------------------------
$(DUMPKEYS_V13_WASM): $(MODULES_DIR)/dumpkeys_v13/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/dumpkeys_v13.wasm

# ---------------------------------------------------------------------------
$(UNICODE_START_V12_WASM): $(MODULES_DIR)/unicode_start_v12/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/unicode_start_v12.wasm

# ---------------------------------------------------------------------------
$(MAPSCRN_V12_WASM): $(MODULES_DIR)/mapscrn_v12/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/mapscrn_v12.wasm

# ---------------------------------------------------------------------------
$(SETMETAMODE_V12_WASM): $(MODULES_DIR)/setmetamode_v12/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/setmetamode_v12.wasm

# ---------------------------------------------------------------------------
$(DUMPKEYS_V14_WASM): $(MODULES_DIR)/dumpkeys_v14/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/dumpkeys_v14.wasm

# ---------------------------------------------------------------------------
$(SETKEYCODES_V12_WASM): $(MODULES_DIR)/setkeycodes_v12/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/setkeycodes_v12.wasm

# ---------------------------------------------------------------------------
$(DUMPKEYS_V15_WASM): $(MODULES_DIR)/dumpkeys_v15/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/dumpkeys_v15.wasm

# ---------------------------------------------------------------------------
$(SHOWKEY_V12_WASM): $(MODULES_DIR)/showkey_v12/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/showkey_v12.wasm

# ---------------------------------------------------------------------------
$(OPENVT_V13_WASM): $(MODULES_DIR)/openvt_v13/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/openvt_v13.wasm

# ---------------------------------------------------------------------------
$(KBD_MODE_V13_WASM): $(MODULES_DIR)/kbd_mode_v13/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/kbd_mode_v13.wasm

# ---------------------------------------------------------------------------
$(FGCONSOLE_V13_WASM): $(MODULES_DIR)/fgconsole_v13/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/fgconsole_v13.wasm

# ---------------------------------------------------------------------------
$(SETFONT_V13_WASM): $(MODULES_DIR)/setfont_v13/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/setfont_v13.wasm

# ---------------------------------------------------------------------------
$(KBD_MODE_V14_WASM): $(MODULES_DIR)/kbd_mode_v14/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/kbd_mode_v14.wasm

# ---------------------------------------------------------------------------
$(FGCONSOLE_V14_WASM): $(MODULES_DIR)/fgconsole_v14/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/fgconsole_v14.wasm

# ---------------------------------------------------------------------------
$(SETFONT_V14_WASM): $(MODULES_DIR)/setfont_v14/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/setfont_v14.wasm

# ---------------------------------------------------------------------------
$(KBD_MODE_V15_WASM): $(MODULES_DIR)/kbd_mode_v15/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/kbd_mode_v15.wasm

# ---------------------------------------------------------------------------
$(FGCONSOLE_V15_WASM): $(MODULES_DIR)/fgconsole_v15/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/fgconsole_v15.wasm

# ---------------------------------------------------------------------------
$(SETFONT_V15_WASM): $(MODULES_DIR)/setfont_v15/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/setfont_v15.wasm

# ---------------------------------------------------------------------------
$(KBD_MODE_V16_WASM): $(MODULES_DIR)/kbd_mode_v16/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/kbd_mode_v16.wasm

# ---------------------------------------------------------------------------
$(FGCONSOLE_V16_WASM): $(MODULES_DIR)/fgconsole_v16/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/fgconsole_v16.wasm

# ---------------------------------------------------------------------------
$(SETFONT_V16_WASM): $(MODULES_DIR)/setfont_v16/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/setfont_v16.wasm

# ---------------------------------------------------------------------------
$(DUMPKEYS_V7_WASM): $(MODULES_DIR)/dumpkeys_v7/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/dumpkeys_v7.wasm

# ---------------------------------------------------------------------------
$(UNICODE_START_V7_WASM): $(MODULES_DIR)/unicode_start_v7/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/unicode_start_v7.wasm

# ---------------------------------------------------------------------------
$(MAPSCRN_V7_WASM): $(MODULES_DIR)/mapscrn_v7/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/mapscrn_v7.wasm

# ---------------------------------------------------------------------------
$(SETKEYCODES_V7_WASM): $(MODULES_DIR)/setkeycodes_v7/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/setkeycodes_v7.wasm

# ---------------------------------------------------------------------------
$(SETMETAMODE_V7_WASM): $(MODULES_DIR)/setmetamode_v7/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/setmetamode_v7.wasm

# ---------------------------------------------------------------------------
$(UNICODE_STOP_V7_WASM): $(MODULES_DIR)/unicode_stop_v7/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/unicode_stop_v7.wasm

# ---------------------------------------------------------------------------
$(CAT_V7_WASM): $(MODULES_DIR)/cat_v7/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/cat_v7.wasm

# ---------------------------------------------------------------------------
$(DATE_V7_WASM): $(MODULES_DIR)/date_v7/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/date_v7.wasm

# ---------------------------------------------------------------------------
$(WC_V7_WASM): $(MODULES_DIR)/wc_v7/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/wc_v7.wasm

# ---------------------------------------------------------------------------
$(TAIL_V7_WASM): $(MODULES_DIR)/tail_v7/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/tail_v7.wasm

# ---------------------------------------------------------------------------
$(UNIQ_V7_WASM): $(MODULES_DIR)/uniq_v7/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/uniq_v7.wasm
