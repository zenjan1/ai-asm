...
TRUNCATE_WASM      = $(MODULES_DIR)/truncate/truncate.wasm $(MODULES_DIR)/nohup/nohup.wasm $(MODULES_DIR)/envsubst/envsubst.wasm $(MODULES_DIR)/dircolors/dircolors.wasm $(MODULES_DIR)/expr/expr.wasm $(MODULES_DIR)/test_cmd/test_cmd.wasm $(MODULES_DIR)/dd/dd.wasm $(MODULES_DIR)/hashsum/hashsum.wasm $(MODULES_DIR)/watch/watch.wasm
NOHUP_WASM         = $(MODULES_DIR)/nohup/nohup.wasm $(MODULES_DIR)/envsubst/envsubst.wasm $(MODULES_DIR)/dircolors/dircolors.wasm $(MODULES_DIR)/expr/expr.wasm $(MODULES_DIR)/test_cmd/test_cmd.wasm $(MODULES_DIR)/dd/dd.wasm $(MODULES_DIR)/hashsum/hashsum.wasm $(MODULES_DIR)/watch/watch.wasm
ENVSUBST_WASM     = $(MODULES_DIR)/envsubst/envsubst.wasm $(MODULES_DIR)/dircolors/dircolors.wasm $(MODULES_DIR)/expr/expr.wasm $(MODULES_DIR)/test_cmd/test_cmd.wasm $(MODULES_DIR)/dd/dd.wasm $(MODULES_DIR)/hashsum/hashsum.wasm $(MODULES_DIR)/watch/watch.wasm
DIRCOLORS_WASM    = $(MODULES_DIR)/dircolors/dircolors.wasm $(MODULES_DIR)/expr/expr.wasm $(MODULES_DIR)/test_cmd/test_cmd.wasm $(MODULES_DIR)/dd/dd.wasm $(MODULES_DIR)/hashsum/hashsum.wasm $(MODULES_DIR)/watch/watch.wasm
EXPR_WASM         = $(MODULES_DIR)/expr/expr.wasm $(MODULES_DIR)/test_cmd/test_cmd.wasm $(MODULES_DIR)/dd/dd.wasm $(MODULES_DIR)/hashsum/hashsum.wasm $(MODULES_DIR)/watch/watch.wasm
TEST_CMD_WASM      = $(MODULES_DIR)/test_cmd/test_cmd.wasm $(MODULES_DIR)/dd/dd.wasm $(MODULES_DIR)/hashsum/hashsum.wasm $(MODULES_DIR)/watch/watch.wasm
DD_WASM           = $(MODULES_DIR)/dd/dd.wasm $(MODULES_DIR)/hashsum/hashsum.wasm $(MODULES_DIR)/watch/watch.wasm
HASHSUM_WASM      = $(MODULES_DIR)/hashsum/hashsum.wasm $(MODULES_DIR)/watch/watch.wasm
WATCH_WASM        = $(MODULES_DIR)/watch/watch.wasm
...
$(INSTALL_WASM): $(MODULES_DIR)/install/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/install.wasm $(KERNEL_DIR)/pathchk.wasm $(KERNEL_DIR)/mktemp.wasm $(KERNEL_DIR)/truncate.wasm $(KERNEL_DIR)/nohup.wasm $(KERNEL_DIR)/envsubst.wasm $(KERNEL_DIR)/dircolors.wasm $(KERNEL_DIR)/expr.wasm $(KERNEL_DIR)/test_cmd.wasm $(KERNEL_DIR)/dd.wasm $(KERNEL_DIR)/hashsum.wasm $(KERNEL_DIR)/watch.wasm
...
$(PATHCHK_WASM): $(MODULES_DIR)/pathchk/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/pathchk.wasm $(KERNEL_DIR)/mktemp.wasm $(KERNEL_DIR)/truncate.wasm $(KERNEL_DIR)/nohup.wasm $(KERNEL_DIR)/envsubst.wasm $(KERNEL_DIR)/dircolors.wasm $(KERNEL_DIR)/expr.wasm $(KERNEL_DIR)/test_cmd.wasm $(KERNEL_DIR)/dd.wasm $(KERNEL_DIR)/hashsum.wasm $(KERNEL_DIR)/watch.wasm
...
$(MKTEMP_WASM): $(MODULES_DIR)/mktemp/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/mktemp.wasm $(KERNEL_DIR)/truncate.wasm $(KERNEL_DIR)/nohup.wasm $(KERNEL_DIR)/envsubst.wasm $(KERNEL_DIR)/dircolors.wasm $(KERNEL_DIR)/expr.wasm $(KERNEL_DIR)/test_cmd.wasm $(KERNEL_DIR)/dd.wasm $(KERNEL_DIR)/hashsum.wasm $(KERNEL_DIR)/watch.wasm
...
$(TRUNCATE_WASM): $(MODULES_DIR)/truncate/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/truncate.wasm $(KERNEL_DIR)/nohup.wasm $(KERNEL_DIR)/envsubst.wasm $(KERNEL_DIR)/dircolors.wasm $(KERNEL_DIR)/expr.wasm $(KERNEL_DIR)/test_cmd.wasm $(KERNEL_DIR)/dd.wasm $(KERNEL_DIR)/hashsum.wasm $(KERNEL_DIR)/watch.wasm
...
$(NOHUP_WASM): $(MODULES_DIR)/nohup/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/nohup.wasm $(KERNEL_DIR)/envsubst.wasm $(KERNEL_DIR)/dircolors.wasm $(KERNEL_DIR)/expr.wasm $(KERNEL_DIR)/test_cmd.wasm $(KERNEL_DIR)/dd.wasm $(KERNEL_DIR)/hashsum.wasm $(KERNEL_DIR)/watch.wasm
...
$(ENVSUBST_WASM): $(MODULES_DIR)/envsubst/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/envsubst.wasm $(KERNEL_DIR)/dircolors.wasm $(KERNEL_DIR)/expr.wasm $(KERNEL_DIR)/test_cmd.wasm $(KERNEL_DIR)/dd.wasm $(KERNEL_DIR)/hashsum.wasm $(KERNEL_DIR)/watch.wasm
...
$(DIRCOLORS_WASM): $(MODULES_DIR)/dircolors/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/dircolors.wasm $(KERNEL_DIR)/expr.wasm $(KERNEL_DIR)/test_cmd.wasm $(KERNEL_DIR)/dd.wasm $(KERNEL_DIR)/hashsum.wasm $(KERNEL_DIR)/watch.wasm
...
$(EXPR_WASM): $(MODULES_DIR)/expr/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/expr.wasm $(KERNEL_DIR)/test_cmd.wasm $(KERNEL_DIR)/dd.wasm $(KERNEL_DIR)/hashsum.wasm $(KERNEL_DIR)/watch.wasm
...
$(TEST_CMD_WASM): $(MODULES_DIR)/test_cmd/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/test_cmd.wasm $(KERNEL_DIR)/dd.wasm $(KERNEL_DIR)/hashsum.wasm $(KERNEL_DIR)/watch.wasm
...
$(DD_WASM): $(MODULES_DIR)/dd/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/dd.wasm $(KERNEL_DIR)/hashsum.wasm $(KERNEL_DIR)/watch.wasm
...
$(HASHSUM_WASM): $(MODULES_DIR)/hashsum/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/hashsum.wasm $(KERNEL_DIR)/watch.wasm
