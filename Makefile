...
ARCH_WASM        = $(MODULES_DIR)/arch/arch.wasm $(MODULES_DIR)/setarch/setarch.wasm $(MODULES_DIR)/nice/nice.wasm $(MODULES_DIR)/renice/renice.wasm $(MODULES_DIR)/timeout/timeout.wasm $(MODULES_DIR)/stdbuf/stdbuf.wasm $(MODULES_DIR)/factor/factor.wasm $(MODULES_DIR)/seq/seq.wasm $(MODULES_DIR)/realpath/realpath.wasm
SETARCH_WASM     = $(MODULES_DIR)/setarch/setarch.wasm $(MODULES_DIR)/nice/nice.wasm $(MODULES_DIR)/renice/renice.wasm $(MODULES_DIR)/timeout/timeout.wasm $(MODULES_DIR)/stdbuf/stdbuf.wasm $(MODULES_DIR)/factor/factor.wasm $(MODULES_DIR)/seq/seq.wasm $(MODULES_DIR)/realpath/realpath.wasm
NICE_WASM        = $(MODULES_DIR)/nice/nice.wasm $(MODULES_DIR)/renice/renice.wasm $(MODULES_DIR)/timeout/timeout.wasm $(MODULES_DIR)/stdbuf/stdbuf.wasm $(MODULES_DIR)/factor/factor.wasm $(MODULES_DIR)/seq/seq.wasm $(MODULES_DIR)/realpath/realpath.wasm
RENICE_WASM      = $(MODULES_DIR)/renice/renice.wasm $(MODULES_DIR)/timeout/timeout.wasm $(MODULES_DIR)/stdbuf/stdbuf.wasm $(MODULES_DIR)/factor/factor.wasm $(MODULES_DIR)/seq/seq.wasm $(MODULES_DIR)/realpath/realpath.wasm
TIMEOUT_WASM     = $(MODULES_DIR)/timeout/timeout.wasm $(MODULES_DIR)/stdbuf/stdbuf.wasm $(MODULES_DIR)/factor/factor.wasm $(MODULES_DIR)/seq/seq.wasm $(MODULES_DIR)/realpath/realpath.wasm
STDBUF_WASM      = $(MODULES_DIR)/stdbuf/stdbuf.wasm $(MODULES_DIR)/factor/factor.wasm $(MODULES_DIR)/seq/seq.wasm $(MODULES_DIR)/realpath/realpath.wasm
FACTOR_WASM       = $(MODULES_DIR)/factor/factor.wasm $(MODULES_DIR)/seq/seq.wasm $(MODULES_DIR)/realpath/realpath.wasm
SEQ_WASM          = $(MODULES_DIR)/seq/seq.wasm $(MODULES_DIR)/realpath/realpath.wasm
REALPATH_WASM     = $(MODULES_DIR)/realpath/realpath.wasm
...
$(PR_WASM): $(MODULES_DIR)/pr/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/pr.wasm $(KERNEL_DIR)/column.wasm $(KERNEL_DIR)/expand.wasm $(KERNEL_DIR)/unexpand.wasm $(KERNEL_DIR)/numfmt.wasm $(KERNEL_DIR)/nproc.wasm $(KERNEL_DIR)/hostid.wasm $(KERNEL_DIR)/sync.wasm $(KERNEL_DIR)/link.wasm $(KERNEL_DIR)/unlink.wasm $(KERNEL_DIR)/logname.wasm $(KERNEL_DIR)/arch.wasm $(KERNEL_DIR)/setarch.wasm $(KERNEL_DIR)/nice.wasm $(KERNEL_DIR)/renice.wasm $(KERNEL_DIR)/timeout.wasm $(KERNEL_DIR)/stdbuf.wasm $(KERNEL_DIR)/factor.wasm $(KERNEL_DIR)/seq.wasm $(KERNEL_DIR)/realpath.wasm
...
$(EXPAND_WASM): $(MODULES_DIR)/expand/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/expand.wasm $(KERNEL_DIR)/unexpand.wasm $(KERNEL_DIR)/numfmt.wasm $(KERNEL_DIR)/nproc.wasm $(KERNEL_DIR)/hostid.wasm $(KERNEL_DIR)/sync.wasm $(KERNEL_DIR)/link.wasm $(KERNEL_DIR)/unlink.wasm $(KERNEL_DIR)/logname.wasm $(KERNEL_DIR)/arch.wasm $(KERNEL_DIR)/setarch.wasm $(KERNEL_DIR)/nice.wasm $(KERNEL_DIR)/renice.wasm $(KERNEL_DIR)/timeout.wasm $(KERNEL_DIR)/stdbuf.wasm $(KERNEL_DIR)/factor.wasm $(KERNEL_DIR)/seq.wasm $(KERNEL_DIR)/realpath.wasm
...
$(UNEXPAND_WASM): $(MODULES_DIR)/unexpand/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/unexpand.wasm $(KERNEL_DIR)/numfmt.wasm $(KERNEL_DIR)/nproc.wasm $(KERNEL_DIR)/hostid.wasm $(KERNEL_DIR)/sync.wasm $(KERNEL_DIR)/link.wasm $(KERNEL_DIR)/unlink.wasm $(KERNEL_DIR)/logname.wasm $(KERNEL_DIR)/arch.wasm $(KERNEL_DIR)/setarch.wasm $(KERNEL_DIR)/nice.wasm $(KERNEL_DIR)/renice.wasm $(KERNEL_DIR)/timeout.wasm $(KERNEL_DIR)/stdbuf.wasm $(KERNEL_DIR)/factor.wasm $(KERNEL_DIR)/seq.wasm $(KERNEL_DIR)/realpath.wasm
...
$(NUMFMT_WASM): $(MODULES_DIR)/numfmt/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/numfmt.wasm $(KERNEL_DIR)/nproc.wasm $(KERNEL_DIR)/hostid.wasm $(KERNEL_DIR)/sync.wasm $(KERNEL_DIR)/link.wasm $(KERNEL_DIR)/unlink.wasm $(KERNEL_DIR)/logname.wasm $(KERNEL_DIR)/arch.wasm $(KERNEL_DIR)/setarch.wasm $(KERNEL_DIR)/nice.wasm $(KERNEL_DIR)/renice.wasm $(KERNEL_DIR)/timeout.wasm $(KERNEL_DIR)/stdbuf.wasm $(KERNEL_DIR)/factor.wasm $(KERNEL_DIR)/seq.wasm $(KERNEL_DIR)/realpath.wasm
...
$(NPROC_WASM): $(MODULES_DIR)/nproc/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/nproc.wasm $(KERNEL_DIR)/hostid.wasm $(KERNEL_DIR)/sync.wasm $(KERNEL_DIR)/link.wasm $(KERNEL_DIR)/unlink.wasm $(KERNEL_DIR)/logname.wasm $(KERNEL_DIR)/arch.wasm $(KERNEL_DIR)/setarch.wasm $(KERNEL_DIR)/nice.wasm $(KERNEL_DIR)/renice.wasm $(KERNEL_DIR)/timeout.wasm $(KERNEL_DIR)/stdbuf.wasm $(KERNEL_DIR)/factor.wasm $(KERNEL_DIR)/seq.wasm $(KERNEL_DIR)/realpath.wasm
...
$(HOSTID_WASM): $(MODULES_DIR)/hostid/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/hostid.wasm $(KERNEL_DIR)/sync.wasm $(KERNEL_DIR)/link.wasm $(KERNEL_DIR)/unlink.wasm $(KERNEL_DIR)/logname.wasm $(KERNEL_DIR)/arch.wasm $(KERNEL_DIR)/setarch.wasm $(KERNEL_DIR)/nice.wasm $(KERNEL_DIR)/renice.wasm $(KERNEL_DIR)/timeout.wasm $(KERNEL_DIR)/stdbuf.wasm $(KERNEL_DIR)/factor.wasm $(KERNEL_DIR)/seq.wasm $(KERNEL_DIR)/realpath.wasm
...
$(SYNC_WASM): $(MODULES_DIR)/sync/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/sync.wasm $(KERNEL_DIR)/link.wasm $(KERNEL_DIR)/unlink.wasm $(KERNEL_DIR)/logname.wasm $(KERNEL_DIR)/arch.wasm $(KERNEL_DIR)/setarch.wasm $(KERNEL_DIR)/nice.wasm $(KERNEL_DIR)/renice.wasm $(KERNEL_DIR)/timeout.wasm $(KERNEL_DIR)/stdbuf.wasm $(KERNEL_DIR)/factor.wasm $(KERNEL_DIR)/seq.wasm $(KERNEL_DIR)/realpath.wasm
...
$(LINK_WASM): $(MODULES_DIR)/link/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/link.wasm $(KERNEL_DIR)/unlink.wasm $(KERNEL_DIR)/logname.wasm $(KERNEL_DIR)/arch.wasm $(KERNEL_DIR)/setarch.wasm $(KERNEL_DIR)/nice.wasm $(KERNEL_DIR)/renice.wasm $(KERNEL_DIR)/timeout.wasm $(KERNEL_DIR)/stdbuf.wasm $(KERNEL_DIR)/factor.wasm $(KERNEL_DIR)/seq.wasm $(KERNEL_DIR)/realpath.wasm
...
$(UNLINK_WASM): $(MODULES_DIR)/unlink/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/unlink.wasm $(KERNEL_DIR)/logname.wasm $(KERNEL_DIR)/arch.wasm $(KERNEL_DIR)/setarch.wasm $(KERNEL_DIR)/nice.wasm $(KERNEL_DIR)/renice.wasm $(KERNEL_DIR)/timeout.wasm $(KERNEL_DIR)/stdbuf.wasm $(KERNEL_DIR)/factor.wasm $(KERNEL_DIR)/seq.wasm $(KERNEL_DIR)/realpath.wasm
...
$(LOGNAME_WASM): $(MODULES_DIR)/logname/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/logname.wasm $(KERNEL_DIR)/arch.wasm $(KERNEL_DIR)/setarch.wasm $(KERNEL_DIR)/nice.wasm $(KERNEL_DIR)/renice.wasm $(KERNEL_DIR)/timeout.wasm $(KERNEL_DIR)/stdbuf.wasm $(KERNEL_DIR)/factor.wasm $(KERNEL_DIR)/seq.wasm $(KERNEL_DIR)/realpath.wasm
...
$(ARCH_WASM): $(MODULES_DIR)/arch/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/arch.wasm $(KERNEL_DIR)/setarch.wasm $(KERNEL_DIR)/nice.wasm $(KERNEL_DIR)/renice.wasm $(KERNEL_DIR)/timeout.wasm $(KERNEL_DIR)/stdbuf.wasm $(KERNEL_DIR)/factor.wasm $(KERNEL_DIR)/seq.wasm $(KERNEL_DIR)/realpath.wasm
...
$(SETARCH_WASM): $(MODULES_DIR)/setarch/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/setarch.wasm $(KERNEL_DIR)/nice.wasm $(KERNEL_DIR)/renice.wasm $(KERNEL_DIR)/timeout.wasm $(KERNEL_DIR)/stdbuf.wasm $(KERNEL_DIR)/factor.wasm $(KERNEL_DIR)/seq.wasm $(KERNEL_DIR)/realpath.wasm
...
$(NICE_WASM): $(MODULES_DIR)/nice/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/nice.wasm $(KERNEL_DIR)/renice.wasm $(KERNEL_DIR)/timeout.wasm $(KERNEL_DIR)/stdbuf.wasm $(KERNEL_DIR)/factor.wasm $(KERNEL_DIR)/seq.wasm $(KERNEL_DIR)/realpath.wasm
...
$(RENICE_WASM): $(MODULES_DIR)/renice/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/renice.wasm $(KERNEL_DIR)/timeout.wasm $(KERNEL_DIR)/stdbuf.wasm $(KERNEL_DIR)/factor.wasm $(KERNEL_DIR)/seq.wasm $(KERNEL_DIR)/realpath.wasm
...
$(TIMEOUT_WASM): $(MODULES_DIR)/timeout/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/timeout.wasm $(KERNEL_DIR)/stdbuf.wasm $(KERNEL_DIR)/factor.wasm $(KERNEL_DIR)/seq.wasm $(KERNEL_DIR)/realpath.wasm
...
$(STDBUF_WASM): $(MODULES_DIR)/stdbuf/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/stdbuf.wasm $(KERNEL_DIR)/factor.wasm $(KERNEL_DIR)/seq.wasm $(KERNEL_DIR)/realpath.wasm
...
$(FACTOR_WASM): $(MODULES_DIR)/factor/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/factor.wasm $(KERNEL_DIR)/seq.wasm $(KERNEL_DIR)/realpath.wasm
...
$(SEQ_WASM): $(MODULES_DIR)/seq/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/seq.wasm $(KERNEL_DIR)/realpath.wasm
