...
LSOF_WASM         = $(MODULES_DIR)/lsof/lsof.wasm $(MODULES_DIR)/iostat/iostat.wasm $(MODULES_DIR)/vmstat/vmstat.wasm $(MODULES_DIR)/mpstat/mpstat.wasm $(MODULES_DIR)/pidof/pidof.wasm $(MODULES_DIR)/pgrep/pgrep.wasm $(MODULES_DIR)/pkill/pkill.wasm $(MODULES_DIR)/top/top.wasm $(MODULES_DIR)/htop/htop.wasm
IOSTAT_WASM       = $(MODULES_DIR)/iostat/iostat.wasm $(MODULES_DIR)/vmstat/vmstat.wasm $(MODULES_DIR)/mpstat/mpstat.wasm $(MODULES_DIR)/pidof/pidof.wasm $(MODULES_DIR)/pgrep/pgrep.wasm $(MODULES_DIR)/pkill/pkill.wasm $(MODULES_DIR)/top/top.wasm $(MODULES_DIR)/htop/htop.wasm
VMSTAT_WASM       = $(MODULES_DIR)/vmstat/vmstat.wasm $(MODULES_DIR)/mpstat/mpstat.wasm $(MODULES_DIR)/pidof/pidof.wasm $(MODULES_DIR)/pgrep/pgrep.wasm $(MODULES_DIR)/pkill/pkill.wasm $(MODULES_DIR)/top/top.wasm $(MODULES_DIR)/htop/htop.wasm
MPSTAT_WASM       = $(MODULES_DIR)/mpstat/mpstat.wasm $(MODULES_DIR)/pidof/pidof.wasm $(MODULES_DIR)/pgrep/pgrep.wasm $(MODULES_DIR)/pkill/pkill.wasm $(MODULES_DIR)/top/top.wasm $(MODULES_DIR)/htop/htop.wasm
PIDOF_WASM        = $(MODULES_DIR)/pidof/pidof.wasm $(MODULES_DIR)/pgrep/pgrep.wasm $(MODULES_DIR)/pkill/pkill.wasm $(MODULES_DIR)/top/top.wasm $(MODULES_DIR)/htop/htop.wasm
PGREP_WASM        = $(MODULES_DIR)/pgrep/pgrep.wasm $(MODULES_DIR)/pkill/pkill.wasm $(MODULES_DIR)/top/top.wasm $(MODULES_DIR)/htop/htop.wasm
PKILL_WASM        = $(MODULES_DIR)/pkill/pkill.wasm $(MODULES_DIR)/top/top.wasm $(MODULES_DIR)/htop/htop.wasm
TOP_WASM         = $(MODULES_DIR)/top/top.wasm $(MODULES_DIR)/htop/htop.wasm
HTOP_WASM        = $(MODULES_DIR)/htop/htop.wasm
...
$(WASM_DIS_WASM): $(MODULES_DIR)/wasm_dis/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/wasm_dis.wasm $(KERNEL_DIR)/shred.wasm $(KERNEL_DIR)/stat.wasm $(KERNEL_DIR)/mcookie.wasm $(KERNEL_DIR)/lsof.wasm $(KERNEL_DIR)/iostat.wasm $(KERNEL_DIR)/vmstat.wasm $(KERNEL_DIR)/mpstat.wasm $(KERNEL_DIR)/pidof.wasm $(KERNEL_DIR)/pgrep.wasm $(KERNEL_DIR)/pkill.wasm $(KERNEL_DIR)/top.wasm $(KERNEL_DIR)/htop.wasm
...
$(SHRED_WASM): $(MODULES_DIR)/shred/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/shred.wasm $(KERNEL_DIR)/stat.wasm $(KERNEL_DIR)/mcookie.wasm $(KERNEL_DIR)/lsof.wasm $(KERNEL_DIR)/iostat.wasm $(KERNEL_DIR)/vmstat.wasm $(KERNEL_DIR)/mpstat.wasm $(KERNEL_DIR)/pidof.wasm $(KERNEL_DIR)/pgrep.wasm $(KERNEL_DIR)/pkill.wasm $(KERNEL_DIR)/top.wasm $(KERNEL_DIR)/htop.wasm
...
$(STAT_WASM): $(MODULES_DIR)/stat/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/stat.wasm $(KERNEL_DIR)/mcookie.wasm $(KERNEL_DIR)/lsof.wasm $(KERNEL_DIR)/iostat.wasm $(KERNEL_DIR)/vmstat.wasm $(KERNEL_DIR)/mpstat.wasm $(KERNEL_DIR)/pidof.wasm $(KERNEL_DIR)/pgrep.wasm $(KERNEL_DIR)/pkill.wasm $(KERNEL_DIR)/top.wasm $(KERNEL_DIR)/htop.wasm
...
$(MODULES_DIR)/top/top.wasm: $(MODULES_DIR)/top/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/top.wasm $(KERNEL_DIR)/htop.wasm
