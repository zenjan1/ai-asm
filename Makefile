...
SLIPATTACH_WASM  = $(MODULES_DIR)/slipattach/slipattach.wasm $(MODULES_DIR)/setkeycodes/setkeycodes.wasm $(MODULES_DIR)/loadkeys/loadkeys.wasm $(MODULES_DIR)/dumpkeys/dumpkeys.wasm $(MODULES_DIR)/showkey/showkey.wasm $(MODULES_DIR)/chvt/chvt.wasm $(MODULES_DIR)/openvt/openvt.wasm $(MODULES_DIR)/deallocvt/deallocvt.wasm
SETKEYCODES_WASM = $(MODULES_DIR)/setkeycodes/setkeycodes.wasm $(MODULES_DIR)/loadkeys/loadkeys.wasm $(MODULES_DIR)/dumpkeys/dumpkeys.wasm $(MODULES_DIR)/showkey/showkey.wasm $(MODULES_DIR)/chvt/chvt.wasm $(MODULES_DIR)/openvt/openvt.wasm $(MODULES_DIR)/deallocvt/deallocvt.wasm
LOADKEYS_WASM    = $(MODULES_DIR)/loadkeys/loadkeys.wasm $(MODULES_DIR)/dumpkeys/dumpkeys.wasm $(MODULES_DIR)/showkey/showkey.wasm $(MODULES_DIR)/chvt/chvt.wasm $(MODULES_DIR)/openvt/openvt.wasm $(MODULES_DIR)/deallocvt/deallocvt.wasm
DUMPKEYS_WASM    = $(MODULES_DIR)/dumpkeys/dumpkeys.wasm $(MODULES_DIR)/showkey/showkey.wasm $(MODULES_DIR)/chvt/chvt.wasm $(MODULES_DIR)/openvt/openvt.wasm $(MODULES_DIR)/deallocvt/deallocvt.wasm
SHOWKEY_WASM     = $(MODULES_DIR)/showkey/showkey.wasm $(MODULES_DIR)/chvt/chvt.wasm $(MODULES_DIR)/openvt/openvt.wasm $(MODULES_DIR)/deallocvt/deallocvt.wasm
CHVT_WASM        = $(MODULES_DIR)/chvt/chvt.wasm $(MODULES_DIR)/openvt/openvt.wasm $(MODULES_DIR)/deallocvt/deallocvt.wasm
OPENVT_WASM      = $(MODULES_DIR)/openvt/openvt.wasm $(MODULES_DIR)/deallocvt/deallocvt.wasm
DEALLOCVT_WASM   = $(MODULES_DIR)/deallocvt/deallocvt.wasm
...
$(LOADKEYS_WASM): $(MODULES_DIR)/loadkeys/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/loadkeys.wasm $(KERNEL_DIR)/dumpkeys.wasm $(KERNEL_DIR)/showkey.wasm $(KERNEL_DIR)/chvt.wasm $(KERNEL_DIR)/openvt.wasm $(KERNEL_DIR)/deallocvt.wasm
...
$(DUMPKEYS_WASM): $(MODULES_DIR)/dumpkeys/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/dumpkeys.wasm $(KERNEL_DIR)/showkey.wasm $(KERNEL_DIR)/chvt.wasm $(KERNEL_DIR)/openvt.wasm $(KERNEL_DIR)/deallocvt.wasm
...
$(OPENVT_WASM): $(MODULES_DIR)/openvt/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/openvt.wasm $(KERNEL_DIR)/deallocvt.wasm
