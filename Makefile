...
NUMFMT_WASM      = $(MODULES_DIR)/numfmt/numfmt.wasm $(MODULES_DIR)/nproc/nproc.wasm $(MODULES_DIR)/hostid/hostid.wasm $(MODULES_DIR)/sync/sync.wasm $(MODULES_DIR)/link/link.wasm $(MODULES_DIR)/unlink/unlink.wasm $(MODULES_DIR)/logname/logname.wasm $(MODULES_DIR)/arch/arch.wasm $(MODULES_DIR)/setarch/setarch.wasm
NPROC_WASM       = $(MODULES_DIR)/nproc/nproc.wasm $(MODULES_DIR)/hostid/hostid.wasm $(MODULES_DIR)/sync/sync.wasm $(MODULES_DIR)/link/link.wasm $(MODULES_DIR)/unlink/unlink.wasm $(MODULES_DIR)/logname/logname.wasm $(MODULES_DIR)/arch/arch.wasm $(MODULES_DIR)/setarch/setarch.wasm
HOSTID_WASM      = $(MODULES_DIR)/hostid/hostid.wasm $(MODULES_DIR)/sync/sync.wasm $(MODULES_DIR)/link/link.wasm $(MODULES_DIR)/unlink/unlink.wasm $(MODULES_DIR)/logname/logname.wasm $(MODULES_DIR)/arch/arch.wasm $(MODULES_DIR)/setarch/setarch.wasm
SYNC_WASM        = $(MODULES_DIR)/sync/sync.wasm $(MODULES_DIR)/link/link.wasm $(MODULES_DIR)/unlink/unlink.wasm $(MODULES_DIR)/logname/logname.wasm $(MODULES_DIR)/arch/arch.wasm $(MODULES_DIR)/setarch/setarch.wasm
LINK_WASM        = $(MODULES_DIR)/link/link.wasm $(MODULES_DIR)/unlink/unlink.wasm $(MODULES_DIR)/logname/logname.wasm $(MODULES_DIR)/arch/arch.wasm $(MODULES_DIR)/setarch/setarch.wasm
UNLINK_WASM      = $(MODULES_DIR)/unlink/unlink.wasm $(MODULES_DIR)/logname/logname.wasm $(MODULES_DIR)/arch/arch.wasm $(MODULES_DIR)/setarch/setarch.wasm
LOGNAME_WASM     = $(MODULES_DIR)/logname/logname.wasm $(MODULES_DIR)/arch/arch.wasm $(MODULES_DIR)/setarch/setarch.wasm
ARCH_WASM        = $(MODULES_DIR)/arch/arch.wasm $(MODULES_DIR)/setarch/setarch.wasm
SETARCH_WASM     = $(MODULES_DIR)/setarch/setarch.wasm
...
$(PR_WASM): $(MODULES_DIR)/pr/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/pr.wasm $(KERNEL_DIR)/column.wasm $(KERNEL_DIR)/expand.wasm $(KERNEL_DIR)/unexpand.wasm $(KERNEL_DIR)/numfmt.wasm $(KERNEL_DIR)/nproc.wasm $(KERNEL_DIR)/hostid.wasm $(KERNEL_DIR)/sync.wasm $(KERNEL_DIR)/link.wasm $(KERNEL_DIR)/unlink.wasm $(KERNEL_DIR)/logname.wasm $(KERNEL_DIR)/arch.wasm $(KERNEL_DIR)/setarch.wasm
...
$(COLUMN_WASM): $(MODULES_DIR)/column/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/column.wasm $(KERNEL_DIR)/expand.wasm $(KERNEL_DIR)/unexpand.wasm $(KERNEL_DIR)/numfmt.wasm $(KERNEL_DIR)/nproc.wasm $(KERNEL_DIR)/hostid.wasm $(KERNEL_DIR)/sync.wasm $(KERNEL_DIR)/link.wasm $(KERNEL_DIR)/unlink.wasm $(KERNEL_DIR)/logname.wasm $(KERNEL_DIR)/arch.wasm $(KERNEL_DIR)/setarch.wasm
...
$(EXPAND_WASM): $(MODULES_DIR)/expand/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/expand.wasm $(KERNEL_DIR)/unexpand.wasm $(KERNEL_DIR)/numfmt.wasm $(KERNEL_DIR)/nproc.wasm $(KERNEL_DIR)/hostid.wasm $(KERNEL_DIR)/sync.wasm $(KERNEL_DIR)/link.wasm $(KERNEL_DIR)/unlink.wasm $(KERNEL_DIR)/logname.wasm $(KERNEL_DIR)/arch.wasm $(KERNEL_DIR)/setarch.wasm
...
$(UNEXPAND_WASM): $(MODULES_DIR)/unexpand/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/unexpand.wasm $(KERNEL_DIR)/numfmt.wasm $(KERNEL_DIR)/nproc.wasm $(KERNEL_DIR)/hostid.wasm $(KERNEL_DIR)/sync.wasm $(KERNEL_DIR)/link.wasm $(KERNEL_DIR)/unlink.wasm $(KERNEL_DIR)/logname.wasm $(KERNEL_DIR)/arch.wasm $(KERNEL_DIR)/setarch.wasm
...
$(NUMFMT_WASM): $(MODULES_DIR)/numfmt/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/numfmt.wasm $(KERNEL_DIR)/nproc.wasm $(KERNEL_DIR)/hostid.wasm $(KERNEL_DIR)/sync.wasm $(KERNEL_DIR)/link.wasm $(KERNEL_DIR)/unlink.wasm $(KERNEL_DIR)/logname.wasm $(KERNEL_DIR)/arch.wasm $(KERNEL_DIR)/setarch.wasm
...
$(NPROC_WASM): $(MODULES_DIR)/nproc/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/nproc.wasm $(KERNEL_DIR)/hostid.wasm $(KERNEL_DIR)/sync.wasm $(KERNEL_DIR)/link.wasm $(KERNEL_DIR)/unlink.wasm $(KERNEL_DIR)/logname.wasm $(KERNEL_DIR)/arch.wasm $(KERNEL_DIR)/setarch.wasm
...
$(HOSTID_WASM): $(MODULES_DIR)/hostid/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/hostid.wasm $(KERNEL_DIR)/sync.wasm $(KERNEL_DIR)/link.wasm $(KERNEL_DIR)/unlink.wasm $(KERNEL_DIR)/logname.wasm $(KERNEL_DIR)/arch.wasm $(KERNEL_DIR)/setarch.wasm
...
$(SYNC_WASM): $(MODULES_DIR)/sync/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/sync.wasm $(KERNEL_DIR)/link.wasm $(KERNEL_DIR)/unlink.wasm $(KERNEL_DIR)/logname.wasm $(KERNEL_DIR)/arch.wasm $(KERNEL_DIR)/setarch.wasm
...
$(LINK_WASM): $(MODULES_DIR)/link/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/link.wasm $(KERNEL_DIR)/unlink.wasm $(KERNEL_DIR)/logname.wasm $(KERNEL_DIR)/arch.wasm $(KERNEL_DIR)/setarch.wasm
...
$(UNLINK_WASM): $(MODULES_DIR)/unlink/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/unlink.wasm $(KERNEL_DIR)/logname.wasm $(KERNEL_DIR)/arch.wasm $(KERNEL_DIR)/setarch.wasm
...
$(LOGNAME_WASM): $(MODULES_DIR)/logname/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/logname.wasm $(KERNEL_DIR)/arch.wasm $(KERNEL_DIR)/setarch.wasm
...
$(ARCH_WASM): $(MODULES_DIR)/arch/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/arch.wasm $(KERNEL_DIR)/setarch.wasm
