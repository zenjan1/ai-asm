...
HOSTID_WASM      = $(MODULES_DIR)/hostid/hostid.wasm $(MODULES_DIR)/sync/sync.wasm $(MODULES_DIR)/link/link.wasm $(MODULES_DIR)/unlink/unlink.wasm $(MODULES_DIR)/logname/logname.wasm $(MODULES_DIR)/arch/arch.wasm $(MODULES_DIR)/setarch/setarch.wasm $(MODULES_DIR)/nice/nice.wasm $(MODULES_DIR)/renice/renice.wasm
SYNC_WASM        = $(MODULES_DIR)/sync/sync.wasm $(MODULES_DIR)/link/link.wasm $(MODULES_DIR)/unlink/unlink.wasm $(MODULES_DIR)/logname/logname.wasm $(MODULES_DIR)/arch/arch.wasm $(MODULES_DIR)/setarch/setarch.wasm $(MODULES_DIR)/nice/nice.wasm $(MODULES_DIR)/renice/renice.wasm
LINK_WASM        = $(MODULES_DIR)/link/link.wasm $(MODULES_DIR)/unlink/unlink.wasm $(MODULES_DIR)/logname/logname.wasm $(MODULES_DIR)/arch/arch.wasm $(MODULES_DIR)/setarch/setarch.wasm $(MODULES_DIR)/nice/nice.wasm $(MODULES_DIR)/renice/renice.wasm
UNLINK_WASM      = $(MODULES_DIR)/unlink/unlink.wasm $(MODULES_DIR)/logname/logname.wasm $(MODULES_DIR)/arch/arch.wasm $(MODULES_DIR)/setarch/setarch.wasm $(MODULES_DIR)/nice/nice.wasm $(MODULES_DIR)/renice/renice.wasm
LOGNAME_WASM     = $(MODULES_DIR)/logname/logname.wasm $(MODULES_DIR)/arch/arch.wasm $(MODULES_DIR)/setarch/setarch.wasm $(MODULES_DIR)/nice/nice.wasm $(MODULES_DIR)/renice/renice.wasm
ARCH_WASM        = $(MODULES_DIR)/arch/arch.wasm $(MODULES_DIR)/setarch/setarch.wasm $(MODULES_DIR)/nice/nice.wasm $(MODULES_DIR)/renice/renice.wasm
SETARCH_WASM     = $(MODULES_DIR)/setarch/setarch.wasm $(MODULES_DIR)/nice/nice.wasm $(MODULES_DIR)/renice/renice.wasm
NICE_WASM        = $(MODULES_DIR)/nice/nice.wasm $(MODULES_DIR)/renice/renice.wasm
RENICE_WASM      = $(MODULES_DIR)/renice/renice.wasm
...
$(PR_WASM): $(MODULES_DIR)/pr/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/pr.wasm $(KERNEL_DIR)/column.wasm $(KERNEL_DIR)/expand.wasm $(KERNEL_DIR)/unexpand.wasm $(KERNEL_DIR)/numfmt.wasm $(KERNEL_DIR)/nproc.wasm $(KERNEL_DIR)/hostid.wasm $(KERNEL_DIR)/sync.wasm $(KERNEL_DIR)/link.wasm $(KERNEL_DIR)/unlink.wasm $(KERNEL_DIR)/logname.wasm $(KERNEL_DIR)/arch.wasm $(KERNEL_DIR)/setarch.wasm $(KERNEL_DIR)/nice.wasm $(KERNEL_DIR)/renice.wasm
...
$(EXPAND_WASM): $(MODULES_DIR)/expand/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/expand.wasm $(KERNEL_DIR)/unexpand.wasm $(KERNEL_DIR)/numfmt.wasm $(KERNEL_DIR)/nproc.wasm $(KERNEL_DIR)/hostid.wasm $(KERNEL_DIR)/sync.wasm $(KERNEL_DIR)/link.wasm $(KERNEL_DIR)/unlink.wasm $(KERNEL_DIR)/logname.wasm $(KERNEL_DIR)/arch.wasm $(KERNEL_DIR)/setarch.wasm $(KERNEL_DIR)/nice.wasm $(KERNEL_DIR)/renice.wasm
...
$(UNEXPAND_WASM): $(MODULES_DIR)/unexpand/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/unexpand.wasm $(KERNEL_DIR)/numfmt.wasm $(KERNEL_DIR)/nproc.wasm $(KERNEL_DIR)/hostid.wasm $(KERNEL_DIR)/sync.wasm $(KERNEL_DIR)/link.wasm $(KERNEL_DIR)/unlink.wasm $(KERNEL_DIR)/logname.wasm $(KERNEL_DIR)/arch.wasm $(KERNEL_DIR)/setarch.wasm $(KERNEL_DIR)/nice.wasm $(KERNEL_DIR)/renice.wasm
...
$(NUMFMT_WASM): $(MODULES_DIR)/numfmt/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/numfmt.wasm $(KERNEL_DIR)/nproc.wasm $(KERNEL_DIR)/hostid.wasm $(KERNEL_DIR)/sync.wasm $(KERNEL_DIR)/link.wasm $(KERNEL_DIR)/unlink.wasm $(KERNEL_DIR)/logname.wasm $(KERNEL_DIR)/arch.wasm $(KERNEL_DIR)/setarch.wasm $(KERNEL_DIR)/nice.wasm $(KERNEL_DIR)/renice.wasm
...
$(NPROC_WASM): $(MODULES_DIR)/nproc/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/nproc.wasm $(KERNEL_DIR)/hostid.wasm $(KERNEL_DIR)/sync.wasm $(KERNEL_DIR)/link.wasm $(KERNEL_DIR)/unlink.wasm $(KERNEL_DIR)/logname.wasm $(KERNEL_DIR)/arch.wasm $(KERNEL_DIR)/setarch.wasm $(KERNEL_DIR)/nice.wasm $(KERNEL_DIR)/renice.wasm
...
$(HOSTID_WASM): $(MODULES_DIR)/hostid/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/hostid.wasm $(KERNEL_DIR)/sync.wasm $(KERNEL_DIR)/link.wasm $(KERNEL_DIR)/unlink.wasm $(KERNEL_DIR)/logname.wasm $(KERNEL_DIR)/arch.wasm $(KERNEL_DIR)/setarch.wasm $(KERNEL_DIR)/nice.wasm $(KERNEL_DIR)/renice.wasm
...
$(SYNC_WASM): $(MODULES_DIR)/sync/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/sync.wasm $(KERNEL_DIR)/link.wasm $(KERNEL_DIR)/unlink.wasm $(KERNEL_DIR)/logname.wasm $(KERNEL_DIR)/arch.wasm $(KERNEL_DIR)/setarch.wasm $(KERNEL_DIR)/nice.wasm $(KERNEL_DIR)/renice.wasm
...
$(LINK_WASM): $(MODULES_DIR)/link/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/link.wasm $(KERNEL_DIR)/unlink.wasm $(KERNEL_DIR)/logname.wasm $(KERNEL_DIR)/arch.wasm $(KERNEL_DIR)/setarch.wasm $(KERNEL_DIR)/nice.wasm $(KERNEL_DIR)/renice.wasm
...
$(UNLINK_WASM): $(MODULES_DIR)/unlink/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/unlink.wasm $(KERNEL_DIR)/logname.wasm $(KERNEL_DIR)/arch.wasm $(KERNEL_DIR)/setarch.wasm $(KERNEL_DIR)/nice.wasm $(KERNEL_DIR)/renice.wasm
...
$(LOGNAME_WASM): $(MODULES_DIR)/logname/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/logname.wasm $(KERNEL_DIR)/arch.wasm $(KERNEL_DIR)/setarch.wasm $(KERNEL_DIR)/nice.wasm $(KERNEL_DIR)/renice.wasm
...
$(ARCH_WASM): $(MODULES_DIR)/arch/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/arch.wasm $(KERNEL_DIR)/setarch.wasm $(KERNEL_DIR)/nice.wasm $(KERNEL_DIR)/renice.wasm
...
$(SETARCH_WASM): $(MODULES_DIR)/setarch/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/setarch.wasm $(KERNEL_DIR)/nice.wasm $(KERNEL_DIR)/renice.wasm
...
$(NICE_WASM): $(MODULES_DIR)/nice/src/main.c
	...
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
	cp $@ $(KERNEL_DIR)/nice.wasm $(KERNEL_DIR)/renice.wasm
