...
PIDOF_WASM        = $(MODULES_DIR)/pidof/pidof.wasm $(MODULES_DIR)/pgrep/pgrep.wasm $(MODULES_DIR)/pkill/pkill.wasm $(MODULES_DIR)/top/top.wasm $(MODULES_DIR)/htop/htop.wasm $(MODULES_DIR)/strace/strace.wasm $(MODULES_DIR)/ltrace/ltrace.wasm $(MODULES_DIR)/tracepath/tracepath.wasm $(MODULES_DIR)/ss/ss.wasm $(MODULES_DIR)/ip/ip.wasm
PGREP_WASM        = $(MODULES_DIR)/pgrep/pgrep.wasm $(MODULES_DIR)/pkill/pkill.wasm $(MODULES_DIR)/top/top.wasm $(MODULES_DIR)/htop/htop.wasm $(MODULES_DIR)/strace/strace.wasm $(MODULES_DIR)/ltrace/ltrace.wasm $(MODULES_DIR)/tracepath/tracepath.wasm $(MODULES_DIR)/ss/ss.wasm $(MODULES_DIR)/ip/ip.wasm
PKILL_WASM        = $(MODULES_DIR)/pkill/pkill.wasm $(MODULES_DIR)/top/top.wasm $(MODULES_DIR)/htop/htop.wasm $(MODULES_DIR)/strace/strace.wasm $(MODULES_DIR)/ltrace/ltrace.wasm $(MODULES_DIR)/tracepath/tracepath.wasm $(MODULES_DIR)/ss/ss.wasm $(MODULES_DIR)/ip/ip.wasm
TOP_WASM         = $(MODULES_DIR)/top/top.wasm $(MODULES_DIR)/htop/htop.wasm $(MODULES_DIR)/strace/strace.wasm $(MODULES_DIR)/ltrace/ltrace.wasm $(MODULES_DIR)/tracepath/tracepath.wasm $(MODULES_DIR)/ss/ss.wasm $(MODULES_DIR)/ip/ip.wasm
HTOP_WASM        = $(MODULES_DIR)/htop/htop.wasm $(MODULES_DIR)/strace/strace.wasm $(MODULES_DIR)/ltrace/ltrace.wasm $(MODULES_DIR)/tracepath/tracepath.wasm $(MODULES_DIR)/ss/ss.wasm $(MODULES_DIR)/ip/ip.wasm
STRACE_WASM       = $(MODULES_DIR)/strace/strace.wasm $(MODULES_DIR)/ltrace/ltrace.wasm $(MODULES_DIR)/tracepath/tracepath.wasm $(MODULES_DIR)/ss/ss.wasm $(MODULES_DIR)/ip/ip.wasm
LTRACE_WASM       = $(MODULES_DIR)/ltrace/ltrace.wasm $(MODULES_DIR)/tracepath/tracepath.wasm $(MODULES_DIR)/ss/ss.wasm $(MODULES_DIR)/ip/ip.wasm
TRACEPATH_WASM    = $(MODULES_DIR)/tracepath/tracepath.wasm $(MODULES_DIR)/ss/ss.wasm $(MODULES_DIR)/ip/ip.wasm
SS_WASM          = $(MODULES_DIR)/ss/ss.wasm $(MODULES_DIR)/ip/ip.wasm
IP_WASM          = $(MODULES_DIR)/ip/ip.wasm
...
$(MODULES_DIR)/ip/ip.wasm: $(MODULES_DIR)/ip/src/main.c
	@echo "  WASM  $<"
	$(CLANG) --target=wasm32-unknown-unknown -Oz -nostdlib -fno-builtin \
	    -Wl,--no-entry -Wl,--export=_start -o $@ $<
