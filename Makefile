...
KBD_MODE_V3_WASM  = $(MODULES_DIR)/kbd_mode_v3/kbd_mode_v3.wasm
...
# Full kernel link
# ---------------------------------------------------------------------------
$(TARGET_ELF): $(ALL_OBJS) $(WASM3_LIB) $(INIT_WASM) $(SHELL_WASM) $(TEST_WASM) $(PING6_WASM) $(PPPD_WASM) $(SLATTACH_WASM) $(SLIPATTACH_WASM) $(SETKEYCODES_WASM) $(LOADKEYS_WASM) $(DUMPKEYS_WASM) $(SHOWKEY_V2_WASM) $(CHVT_V2_WASM) $(OPENVT_V2_WASM) $(DEALLOCVT_V2_WASM) $(FGCONSOLE_V2_WASM) $(SETFONT_V2_WASM) $(KBD_MODE_V2_WASM) $(SHOWKEY_V3_WASM) $(CHVT_V3_WASM) $(OPENVT_V3_WASM) $(DEALLOCVT_V3_WASM) $(FGCONSOLE_V3_WASM) $(SETFONT_V3_WASM) $(KBD_MODE_V3_WASM) $(RAMDISK_TAR)
	@echo "  LD    $@"
